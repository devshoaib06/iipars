    ...
    <section class="content" style="margin-top: 12px;">
      ...
      <div class="box" style="padding: 12px;">
            ...
            <div class="box-header">
              <h3 class="box-title">Video Category(<?php  echo count($video_category_list);?>)</h3><br><br>
                <span> <span class="btn btn-primary btn-sm" onclick="add_role_modal();">Add Video Category</span> </span> 
