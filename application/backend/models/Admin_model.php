...
class admin_model extends CI_Model
{
    ...
    function check_login($username,$password)
    {
        ...
        // $this->db->or_where('user_type_id','6');
        $query=$this->db->get();
        return $query->result();
    }
    ...
    function selectAll_desc($table_name)
    {
        $this->db->select('*');
        $this->db->from($table_name);
    ...
    function order_export($start_date, $end_date)
{
   

    $this->db->select('*');
    $this->db->from('tbl_order_details');
    $this->db->where('order_created_date >=', $start_date);
    $this->db->where('order_created_date <=', $end_date);
...
function all_order_export($start_date, $end_date)
{
