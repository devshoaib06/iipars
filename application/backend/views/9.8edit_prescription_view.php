          ...
          <select  class="form-control" style="display: none;">
                                         ...
                                         <div class="form-group frm-diff new_desin C_C">
                                            ...
                                            <div class="all-p-add-pplus-mina">
                                              <div class="right-p-sec-pp">
                                                <td>
                                                     <a href="javacript:void(0)"  id="edu_no2_2" onclick="edu_produce_file_box_cc(2)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_cc(2);"><b>-</b></a></td>
                                                  </div>
          ...
          <select  class="form-control" style="display: none;">
                                         ...
                                         <div class="form-group frm-diff new_desin C_C">
                                            ...
                                            <div class="all-p-add-pplus-mina">
                                              <div class="right-p-sec-pp">
                                                <td>
                                                     <a href="javacript:void(0)"  id="edu_no2_3" onclick="edu_produce_file_box_cc(3)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_cc(3);"><b>-</b></a></td>
                                                  </div>
          ...
          <select  class="form-control" style="display: none;">
                                         ...
                                         <div class="form-group frm-diff new_desin C_C">
                                            ...
                                            <div class="all-p-add-pplus-mina">
                                              <div class="right-p-sec-pp">
                                                <td>
                                                     <a href="javacript:void(0)"  id="edu_no2_4" onclick="edu_produce_file_box_cc(4)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_cc(4);"><b>-</b></a></td>
                                                  </div>
          ...
          <select  class="form-control" style="display: none;">
                                         ...
                                         <div class="form-group frm-diff new_desin C_C">
                                            ...
                                            <div class="all-p-add-pplus-mina">
                                              <div class="right-p-sec-pp">
                                                <td>
                                                     <a href="javacript:void(0)"  id="edu_no2_5" onclick="edu_produce_file_box_cc(5)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_cc(5);"><b>-</b></a></td>
                                                  </div>
                                       ...
                                       <a href="javacript:void(0)" class="btn btn-primary negative_btn dwn" id="minus" onclick="price_hiding_out_ho('<?php echo $i+1; ?>');"><b>-</b></a>
                                        ...
                                        <a href="javacript:void(0)"  id="edu_no3_1" onclick="edu_produce_file_box_ho('1')" class="btn btn-primary"><b>+</b></a>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_2" onclick="edu_produce_file_box_ho(2)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(2);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_3" onclick="edu_produce_file_box_ho(3)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(3);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_4" onclick="edu_produce_file_box_ho(4)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(4);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_5" onclick="edu_produce_file_box_ho(5)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(5);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_6" onclick="edu_produce_file_box_ho(6)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(6);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_7" onclick="edu_produce_file_box_ho(7)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(7);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_8" onclick="edu_produce_file_box_ho(8)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(8);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_9" onclick="edu_produce_file_box_ho(9)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(9);"><b>-</b></a></td>
                                          ...
                                          <div class="form-group frm-diff new_desin_day Days_c_c">
                                            ...
                                            <div class="inder-left-sec">
                                                <td>
                                                      <a href="javacript:void(0)"  id="edu_no3_10" onclick="edu_produce_file_box_ho(10)" class="btn btn-primary"><b>+</b></a>
                                                </td>
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out_ho(10);"><b>-</b></a></td>
  ...
  <?php /*foreach($product_price as $price){*/
                              ...
                              <div class="form-group frm-diff new_desin">
                                         <label for="product_name" class=" control-label">Disease</label>
                                          <div class="col-sm-8">
                                             <select  class="form-control select" style="pointer-events: none"  name="group[]" onchange="get_med(this.value,1)" id="group_1"  required="">
...
<div class="form-group frm-diff disease-medi-p-cus new_desin_mediam Disease_Medicine">
  ...
  if(count($data['patient_med9'])>0){
          foreach($data['patient_med9'] as $row)
          {

                                                $this->db->select('*');
                                               $this->db->from('tbl_medicine');
                                              
                                               $this->db->where('medicine_id',$row->medicine_id);
                                              
                                               $qry=$this->db->get();
                                               $data['patient_med7']=$qry->result();
   ?>
  <div class="processing_cont" id="get_des_med_1" style="min-height: 1px;overflow-y:scroll;max-height: 200px;" >

  <div   class="col-md-12 processing_cont_form"><div class="col-md-12 loop"><div class="col-xs-1">

  <input type="checkbox" style="pointer-events: none" <?php if($patient_med[$i]->medicine_id==$row->medicine_id) { echo "checked"; }   ?>  name="medicine<?php echo $i+1; ?>" id="medicine_<?php echo $row->medicine_id; ?>" value="<?php echo $row->medicine_id; ?>" >

  </div> <div class="col-xs-10"><label><?php  foreach($data['patient_med7'] as $row1 ){  echo @$row1->medicine_name; }  ?></label>
  ...
  <?php } } ?>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(2);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(3);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(4);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(5);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(6);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(7);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(8);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(9);"><b>-</b></a></td>
                      ...
                      <div class="advice-section-btn-plus-p-cus">
                                            <div class="medi-p-cus-btn-right">
                                                ...
                                                <td>
                                                    <a href="javacript:void(0)" class="btn btn-primary" id="minus" onclick="edu_hiding_out(10);"><b>-</b></a></td>
...
<script>
  ...
  <script type="text/javascript">
    function addNewCCs(index){
        ...
        var html_data = '';
            ...
            html_data +='<label for="product_name" class=" control-label">C/C</label>';
  ...
  <script>
    function addNewHOs(index){
      ...
      html_data +='<div class="form-group frm-diff">';
          html_data +='<label for="product_name" class=" control-label">H/O</label>';
          html_data +='<div class="col-sm-8">';                                               
              html_data +='<div id="null">';
