 ...
 <div class="box-content">
     <?php if($this->session->flashdata('message')) { ?> 
        <table class="table table-striped table-bordered bootstrap-datatable ">
         ...
         <?php } ?>
      <div class="box-content">
        <form action="<?php echo base_url();?>index.php/add_controller/add_controller_action" method="post" id="add_page">
        <table class="table table-striped table-bordered bootstrap-datatable">         
                 ...
                 <table class="table table-striped table-bordered bootstrap-datatable">  
                 <tr>
                <td colspan="2" style="padding-left:410px;"><strong>CONTROLLER MANAGE  </strong></td> 
              ...
              <tr>
                ...
                <?php foreach($management_list as $management){ ?>
               
                <option value="<?php  echo $management->management_id; ?>"><?php  echo $management->management_name; ?> </option>
                <?php } ?>
                </select>
                ...
                <td><input type="text" required="" id="title" name="title" value="<?php echo $this->session->flashdata('title'); ?>" style="width:56%"/>
                </td>
              </tr>    
               <tr>
                <td style="width:20%;"><strong>Rout  </strong></td> 
                <td><input type="text" id="controller" required="" name="controller" value="<?php echo $this->session->flashdata('controller'); ?>" style="width:56%" />
                </td>
              </tr>   
