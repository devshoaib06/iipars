    ...
    <section class="content">
        ...
        <span class="box-title" style="color:green"><?php echo $this->session->flashdata('msg'); ?></span>
                    ...
                    <div class="box-body pad">
                        <form action="<?php echo base_url()?>index.php/admin_appointment/close_dates_action" class="form-horizontal" id="main" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div id="time">
                        <div class="form-group"  id="form-group_0" style="margin-top: 10px;">
                            <div class="select-time-form padding-top-10 clearfix" >
                                ...
                                <div class="col-sm-7">
                                  <input type="text" class="form-control fromdate" name="close_start_date[]" id="fromdate" style="margin-bottom: 20px" placeholder="Closing Date:yyyy-mm-dd" required="">
                                </div>
