      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form name="form" id="client_form" class="form-horizontal form" action="<?php echo base_url();?>index.php/admin_appointment/appointment_details" method="post" enctype="multipart/form-data">
              <div class="box-body">
 ...
 <!--  <div class="form-heading">
   <h4>Appointment Date</h4>
           ...
           <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <input type="hidden" class="form-control" id="app_date" name="app_date" placeholder="mm/dd/yyyy " value="<?php echo $appointment_details[0]->appointment_date; ?>">
           ...
           <!-- <div class="form-group">
              ...
              <div class="box-footer">
               ...
               <!--  <button type="submit" class="btn btn-info pull-right" id="cont_sub" >Continue</button> -->
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
