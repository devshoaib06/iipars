...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/sub_admin_list_manage/role_management">Service Provider</a></li>
    ...
    <section class="content" style="margin-top: 12px;">
      ...
      <div class="box" style="padding: 12px;">
            ...
            <div class="box-header">
              <h3 class="box-title">Service Provider (<?php  echo count($cc_list);?>)</h3><br><br>
               <span> <span class="btn btn-primary btn-sm" onclick="add_role_modal();">Add Service Provider</span> </span>
               ...
               ?>
                <tr>
                   <!--  <td><?php echo $sl++; ?></td> -->
                	 ...
                	 <td><input type="checkbox" name="record" value="<?php echo $row->cc_id;?>"></td>
                   <td>
                	...
                	<td>
                       ...
                       <a id="edit_role_btn_<?php echo $row->cc_id; ?>" class="btn btn-success btn-sm" title="Edit" href="javascript:void(0);" onclick="edit_cc(<?php echo $row->cc_id; ?>);">
                          <i id="edit_role_icon_<?php echo $row->cc_id; ?>" class="fa fa-pencil-square-o"></i>
                       </a>
<?php 
 $data_chk = $this->common->select($table_name='tbl_university',$field=array(), $where=array('university_type'=>$row->cc_id), $where_or=array(),$like=array(),$like_or=array(),$order=array(),$start='',$end='');

 if(count($data_chk)==0)
 {
 ?>
                      
                          <a href="<?php echo base_url()?>index.php/admin_service/cc_delete/<?php echo $row->cc_id; ?>" class="btn-danger btn-sm" name="" id="" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
      ...
      <div class="modal-header">
        ...
        <h3>Add Service Provider</h3>
          ...
          <div class="modal-body">
              <div>
              <fieldset>   
                   <form action="<?php echo base_url(); ?>index.php/admin_service/add_cc_action" id="add_role_form" method="post">
                  <div class="control-group" id="edit_discount_control">
                     <label class="control-label" for="inputSuccess2">Service Provider</label>
                     <div class="controls">
                       <input type="text" name="cc_name" id="cc_name" class="form-control" placeholder="" required=""  autocomplete="off">
                     <br> 
                     </div>
                  </div>
                  </form>
      ...
      <div class="modal-header">
        ...
        <h3>Edit Service Provider</h3>
          ...
          <div class="modal-body">
              <div>
              <fieldset>   
                   <form action="<?php echo base_url(); ?>index.php/admin_service/edit_cc_action" id="edit_role_form"  method="post">
                  <div class="control-group" id="edit_discount_control">
                     <input type="hidden" name="cc_id" id="role_id_ed" value="">
                     <label class="control-label" for="inputSuccess2">Service Provider </label>
                     <div class="controls">
                       <input type="text" name="cc_name" id="role_title_ed" class="form-control" placeholder="" required=""  value="" autocomplete="off">
                     <br> 
                     </div>
                  </div>
                  </form>
       ...
       function change_sts_active(val)
        {
          //alert(val);
            ...
            if(pro_ids.length>0)
            {
              ...
              url:base_url+'index.php/admin_service/change_to_active',
...
function add_role_validate()
{
        ...
        if (!isNull(cc_name)) 
        {
          ...
          $("#cc_name").attr("data-toggle", "tooltip");
                ...
                document.getElementById('cc_name').title = 'Type Is Required';
...
$.ajax(
    {   
        type: "POST",
        dataType:'json',  
        url:"<?php echo base_url();?>index.php/admin_service/edit_kpo_json",  
        data: {cc_id:cc_id},
        //async: false,
        success: function(data)
        {     
