...
<head>
 ...
 <!--    <script src="<?php echo base_url()?>custom_css/form_validation.css"></script> -->
    ...
    <script src="<?php echo base_url()?>compress/bootstrap-datepicker.js"></script>
...
<header class="main-header">
    ...
    <a href="" class="logo">
        ...
        <span class="logo-mini">OPD</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">OPD</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
         ...
         <a href="<?php echo base_url(); ?>index.php/admin_user/add_patient"  style="float: left; padding: 15px 15px;margin-left: 30%"  role="button">
            <span  class="label label-warning">Patient Add</span>

     
        </a>

           <a href="<?php echo base_url(); ?>index.php/admin_prescription"  style="float: left; padding: 15px 15px;margin-left: 5%"  role="button">
            <span class="label label-danger">Prescription List</span>

        </a>

          <a href="<?php echo base_url(); ?>index.php/admin_prescription/add_prescription"  style="float: left; padding: 15px 15px;margin-left: 5%"  role="button">
            <span class="label label-success">Prescription Add</span>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!--<li class="user-body">
                            ...
                            <div class="">
                                <a href="#" class="btn btn-default" style="margin-top:10px">Change Password</a>
                            </div>
                        </li>-->
