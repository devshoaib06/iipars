        ...
        <ul class="sidebar-menu">
             ...
             <li class="treeview <?php if (@$active == "video" || @$active == "Manage_image_category" || @$active == "video_category_list") {
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php if (@$active == "video") {
                                    echo "active";
                                } ?>"><a href="<?php echo base_url(); ?>index.php/manage_media/video_gallery_view"><i class="fa fa-list" aria-hidden="true"></i>Video Gallery</a></li>


                    <li class="<?php if (@$active == "image_gallery_view") {
                                    echo "active";
                                } ?>"><a href="<?php echo base_url(); ?>index.php/manage_media/image_gallery_view"><i class="fa fa-list" aria-hidden="true"></i>Image Gallery</a></li>
            ...
            <li class="treeview <?php if (@$active == "page_list_manage") {
                ...
                <li class="treeview <?php if (@$active == "book_list_manage") {
                    ...
                    <a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i><span> Book publication management</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">

                        <li class="<?php if (@$active == "book_publication_manage") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/book_publication_manage"><i class="fa fa-list" aria-hidden="true"></i>Manage Book publication</a></li>
                ...
                <li class="treeview <?php if (@$active == "write_list_manage") {
                    ...
                    <a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i><span> Writing Consultancy management</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">

                        <li class="<?php if (@$active == "writing_consultancy_manage") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/writing_consultancy_manage"><i class="fa fa-list" aria-hidden="true"></i>Manage Writing Consultancy</a></li>
                ...
                <li class="treeview <?php if (@$active == "academic") {
                    ...
                    <a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i><span> Academic management</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">

                        <li class="<?php if (@$active == "paper") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/paper"><i class="fa fa-list" aria-hidden="true"></i>Manage Paper Call</a></li>
                        <li class="<?php if (@$active == "refresher") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/refresher"><i class="fa fa-list" aria-hidden="true"></i>Manage Refresher Course</a></li>

                        <li class="<?php if (@$active == "orientation") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/orientation"><i class="fa fa-list" aria-hidden="true"></i>Manage Orientation Program</a></li>
                        
                        <li class="<?php if (@$active == "seminar") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/seminar"><i class="fa fa-list" aria-hidden="true"></i>Manage Seminar</a></li>

                        <li class="<?php if (@$active == "conference") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/conference"><i class="fa fa-list" aria-hidden="true"></i>Manage Conference</a></li>

                        <li class="<?php if (@$active == "workshop") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/workshop"><i class="fa fa-list" aria-hidden="true"></i>Manage Workshop</a></li> 
                                    
                        <li class="<?php if (@$active == "phd") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/phd"><i class="fa fa-list" aria-hidden="true"></i>Manage Ph.D. Entrance Test</a></li>
                        
                        <li class="<?php if (@$active == "mphil") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/mphil"><i class="fa fa-list" aria-hidden="true"></i>Manage M. Phil. Admission</a></li>                                                                        
                    </ul>
                ...
                <li class="treeview <?php if (@$active == "current_affairs") {
                    ...
                    <a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i><span> Current affairs </span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">

                        <li class="<?php if (@$active == "current_affairs") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/current_affairs"><i class="fa fa-list" aria-hidden="true"></i>Manage current affairs category</a></li>
                        <li class="<?php if (@$active == "current_affairs/list") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/current_affairs/list"><i class="fa fa-list" aria-hidden="true"></i>Manage current affairs list</a></li>
                 ...
                 <li class="treeview <?php if (@$active == "current_affairs") {
                    ...
                    <a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i><span> UGC-NET Update </span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">

                        <li class="<?php if (@$active == "ugc_video") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/ugc_video"><i class="fa fa-list" aria-hidden="true"></i>Manage Video</a></li>
                        <li class="<?php if (@$active == "ugc_other/list") {
                                        echo "active";
                                    } ?>"><a href="<?php echo base_url(); ?>index.php/ugc_other/list"><i class="fa fa-list" aria-hidden="true"></i>Manage  Other</a></li>
