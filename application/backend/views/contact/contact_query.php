        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Contact Query(<?php echo count($contact_query); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <?php } ?> -->
              ...
              <span style="padding-left: 85%">
                ...
                <a href="<?php echo base_url();?>index.php/admin_contact/export_csv_ebook_list" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i>Export CSV</a>
         ...
         <td> 
          ...
          <!-- <a href="<?php echo base_url();?>index.php/admin_contact/export_csv_ebook_list/<?php echo $row->id; ?>" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i></a> -->
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/admin_contact/delete/'+id;
  }
}
