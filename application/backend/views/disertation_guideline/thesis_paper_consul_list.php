        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All THESIS CONSULTANCY(<?php echo count($thesis_paper_list); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <?php } ?> -->
              ...
              <span style="padding-left: 85%">
                ...
                <a href="<?php echo base_url();?>index.php/manage_disertation_guideline/export_csv_research_paper_list" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i>Export CSV</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
                $i=0;
                foreach($thesis_paper_list as $row)
                {
                  $i++;
               ...
               <!--  
                ...
                <td><?php echo $row->chapter1; ?></td>
                <td><?php echo $row->chapter2; ?></td>
                <td><?php echo $row->chapter3 ; ?></td>
                <td><?php echo $row->chapter4 ; ?></td>
                <td><?php echo $row->chapter5 ; ?></td>
                <td><?php echo $row->chapter6 ; ?></td>
                <td><?php echo $row->chapter7 ; ?></td>
         ...
         <td> 
          ...
          <!-- <a href="<?php echo base_url();?>index.php/manage_disertation_guideline/export_csv_research_paper_list/<?php echo $row->id; ?>" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i></a> -->
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/manage_disertation_guideline/delete/'+id;
  }
}
