...
<div class="content-wrapper">
    ...
    <form class="" method="post" action="<?php echo base_url(); ?>index.php/admin_user/doctor_edit_action" id="doc_add_form">
                        ...
                        <div class="tab-content">
                                ...
                                <div id="vital_info" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="first_name" value="<?php echo @$user_doc[0]->first_name; ?>" id="first_name" placeholder="First Name" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                              <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="last_name" value="<?php echo @$user_doc[0]->last_name; ?>" id="last_name" placeholder="Last Name" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="email" name="email" onkeyup="email_check(value)" id="email" value="<?php echo @$user_doc[0]->login_email; ?>" placeholder="Email" style="margin-bottom:12px" >
                                         ...
                                         <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="password" name="pass" value="<?php echo @$user_doc[0]->login_pass; ?>" id="pass" placeholder="Password" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="mobile" value="<?php echo @$user_doc[0]->mobile; ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="mobile" maxlength="11" style="margin-bottom:12px" placeholder="Mobile No">
                                            </div>
                                        </div>
                                         ...
                                         <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="age" id="age" value="<?php echo @$user_doc[0]->age; ?>" style="margin-bottom:12px" placeholder="Age">
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input  type="radio" name="gen" id="gen" value="male" <?php if(@$user_doc[0]->gender=='Male'){ echo 'checked'; } ?> style="margin-bottom:12px">Male
                        ...
                        <div class="tab-content">
                                ...
                                <div id="vital_info" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" type="text" name="exp" id="exp" style="margin-bottom:12px" placeholder="Experience">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="reg_no" id="reg_no" value="<?php echo @$doc[0]->reg_no; ?>" style="margin-bottom:12px" placeholder="Registration No">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="date" name="start" id="start" value="<?php echo @$doc[0]->start_year; ?>" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                     ...
                                     ?>
                                       ...
                                       <div id="price_<?php echo $i+1; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                               <select  class="form-control select" name="chamber[]" id="chamber"  required="">
                                                   ...
                                                   <option value="<?php echo $row->chamber_id; ?>" <?php if($doc_chamber[$i]->chamber_id==$row->chamber_id){ echo 'selected'; } ?>><?php echo $row->chamber_name; ?></option>
                                                  <?php
                                                    }
                                                  ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="fees[]" id="fees" value="<?php echo $doc_chamber[$i]->fees; ?>" style="margin-bottom:12px" placeholder="Fees">
                                            </div>
                                        </div>
                                        </div>
                                                <?php
