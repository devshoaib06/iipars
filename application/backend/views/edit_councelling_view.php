        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Councelling Edit</h3>
            <div id="validation" style="color:red;"></div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin_cc/edit_councelling_action" method="post"  >
            <input type="hidden" value="<?php echo @$councelling[0]->councelling_id; ?>" name="councelling_id">
              <div class="box-body">
             ...
             <!--   <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="councelling" required="" id="councelling" class="form-control" placeholder="councelling Name" value="<?php echo @$councelling[0]->councelling_name; ?>">
