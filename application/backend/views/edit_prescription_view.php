...
<div class="all-add-prescription-section">
      ...
      <form action="<?php echo base_url(); ?>index.php/admin_user/prescription_edit" id="doc_add_form7" method="post">
...
<div class="first-part-loop" id="patient_cc_<?php echo $i+1; ?>">
          <div class="first-part">
          <div class="col-md-12">
            <div class="form-group">
              <div class="col-md-4">
             ...
             <select class="form-control select2" name="cc[]" id="cc_0">
                  ...
                  <?php $days =  $this->common->select($table_name='tbl_time',$field=array(), $where=array(), $where_or=array(),$like=array(),$like_or=array(),$order=array(),$start='',$end='');
                                                ?>
                                                    ...
                                                    <?php 
                                                        ...
                                                        {
                                                     ?>
                                                    <option value="<?php echo $row->id; ?>"<?php if($row->id==@$patient_cc[$i]->day_id){ echo 'selected'; } ?>><?php echo $row->day; ?></option>
                                                    <?php } ?>
              ...
              <div class="col-md-1">
                <div class="plus-min-btn">
                  <span class="min-btn">
                    <i class="fa fa-minus" aria-hidden="true" id="minus" onclick="price_hiding_out_cc('<?php echo $i+1; ?>');"></i>
                  </span>
...
<option value="<?php echo $row->id; ?>"><?php echo $row->day; ?></option>
  ...
  <select  name="diagnosis[]" id="diagnosis" multiple class="chosen-select">
                                                    <?php
...
<?php 
                            if(count($patient_ho)>0){
                                           for($i=0;$i<count($patient_ho);$i++)
                                            {
                                              ?>
         <div class="second-part-loop" id="patient_ho_<?php echo $i+1; ?>">
          <div class="second-part">
          <div class="form-group">
              <div class="col-md-4">
              ...
              <div class="col-md-2">
                <div class="ho-dignosis">
                <label>Days</label>
               <input type="text" class="form-control" value="<?php echo @$patient_ho[$i]->day_id; ?>" name="dose_ho[]" id="dose_ho_0">
              </div>
              </div>
              </div>
              <div class="col-md-1">
                 <div class="plus-min-btn">
                  <span class="min-btn" id="minus" onclick="price_hiding_out_ho(<?php echo $i+1; ?>);">
                    <i class="fa fa-minus"  aria-hidden="true"></i>
                  </span>
 ...
 <option value="<?php echo $row->ho_id; ?>" >
  ...
  <select data-placeholder="Choose General Exam" name="gen[]" id="gen" multiple class="chosen-select">
              ...
              <div class="col-md-8">
                <div class="col-md-4">
                  ...
                  <label>Pulse</label>
               <input type="text" name="pulse" id="pulse" value="<?php echo @$patient_chk[0]->pulse; ?>" placeholder="Pulse" class="form-control">
             </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="bp-section">
                    <label>BP</label>
                       <input type="text" name="upper" value="<?php echo @$patient_chk[0]->bp_upper; ?>" id="upper" placeholder="Upper" class="form-control">
                       <input type="text" name="lower" value="<?php echo @$patient_chk[0]->bp_lower; ?>" id="lower" placeholder="Lower" class="form-control" >
                     </div>
                </div>
              </div>
            </div>
  ...
  <select data-placeholder="Choose Investigation" name="investigation[]" id="investigation" multiple class="chosen-select">
     ...
     <?php
               ...
               <?php                      if(count($patient_report)>0)
                                           {
                                           for($in=0;$in<count($patient_report);$in++)
                                            {
                                              ?>
<div class="all-report-section-p-cus" id="patient_report_<?php echo $i+1; ?>">
                <div class="col-md-4">
                  <div class="report-section">
                  <label>Report</label>
                     <select class="form-control select2" name="write[]" id="write">
                ...
                <div class="col-md-4">
                  <div class="report-blank-section">
                         <label></label>
                     <input type="text" name="write_some[]" value="<?php echo @$patient_report[$in]->description; ?>" class="form-control">
                ...
                <div class="col-md-3">
                  <div class="report-days-section">
                  <!-- <label>Date</label> -->
                  <input type="text" name="date[]" value="<?php echo @$patient_report[$in]->date; ?>" name="date[]" class="form-control datepicker">
                </div>
                </div>
                <div class="plus-minus-btn-sec">
                <div class="col-md-1">
                  <div class="plus-min-btn">
                   <span class="min-btn" id="minus" onclick="patient_report_hiding_out(<?php echo $i+1; ?>);">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                  </span> 
...
<div class="all-report-section-p-cus" id="add_more_edu_report_no_<?php echo $i; ?>" style="display: none;">
  ...
  function edu_hiding_out(val)
  {
      ...
      <?php if(count($patient_med)>0){ ?>
        <div class="fourth-section-first-part" id="price1_1">
          <div class="col-md-12">
            <div class="form-group">
              <div class="col-md-4">
                <div class="disease-section">
                <label>Disease</label>
   <select class="form-control select" name="group[]" style="pointer-events: none" onchange="get_med(this.value,1)" id="group1">
      <?php
                                                       foreach($group as $row){

                                                        ?>

                                                   <option value="<?php echo @$row->group_id; ?>" <?php if(@$row->group_id==@$patient_med[0]->group_id) { echo "selected"; } ?>><?php echo @$row->group_name; ?></option>
                                                  <?php
                                                    }
                                                  ?>
                ...
                <div class="disease-medicine-section-all">
                  ...
                  <div class="all-disease-check-box-sec" id="" style="min-height: 1px;overflow-y:scroll;max-height: 200px;">
                  ...
                  <?php 
                                               ...
                                               $this->db->where('tgm.group_id',@$patient_med[0]->group_id);
  ...
  if(count($data['patient_med9'])>0){
   ...
   ?>
                  ...
                  <input type="checkbox"  <?php  foreach($data['patient_med7'] as $row1){ if(@$row1->medicine_id==@$row->medicine_id){ echo "checked"; } }  ?>  name="medicine1[]" id="medicine1" value="<?php echo @$row->medicine_id; ?>" ><span class="dd-nc"> <?php   echo @$row->medicine_name;  ?></span>
              ...
              <div class="col-md-1">
                <div class="plus-min-btn">
                   <span class="min-btn" id="minus" onclick="price_hiding_out1(1);">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                  </span> 
                  <span class="plus-btn" id="edu_no_<?php echo count($patient_med)+1; ?>" onclick="edu_produce_file_box(<?php echo count($patient_med)+1; ?>)">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                  </span>
                </div>
              </div>
   ...
   <div class="fourth-section-first-part">
     ...
     <option value="">--Select Group--</option>
        ...
        <input type="hidden" value="<?php echo count($patient_med); ?>" id="hidden_med">
        <div class="fourth-section-firts-part-loop-section">

         <?php
                                           for($i=1;$i<=count($patient_med)-1;$i++)
                                            {
                                               ...
                                               $this->db->where('tgm.group_id',$patient_med[$i]->group_id);
                                              
                                               $qry=$this->db->get();
                                               $data['patient_med9']=$qry->result();

                                               //echo "<pre>";print_r($data['patient_med9']);exit;

                                              ?>

 
           <div class="fourth-section-first-part" id="price1_<?php echo $i+1; ?>">
          <div class="col-md-12">
            <div class="form-group">
              <div class="col-md-4">
                <div class="disease-section">
                <label>Disease</label>
                     <select class="form-control select" name="group[]" style="pointer-events: none" onchange="get_med(this.value,<?php echo $i+1; ?>)" id="group_<?php echo $i; ?>">
      <?php
                                                       foreach($group as $row){
  ...
  if(count($data['patient_med9'])>0){
   ...
   ?>
                  ...
                  <input type="checkbox"  <?php  foreach($data['patient_med7'] as $row1){ if($row1->medicine_id==$row->medicine_id){ echo "checked"; } }  ?>  name="medicine<?php echo $i+1; ?>[]" id="medicine_<?php echo $i+1; ?>" value="<?php echo $row->medicine_id; ?>" ><span class="dd-nc"> <?php   echo @$row->medicine_name;  ?></span>
              ...
              <div class="col-md-1">
                <div class="plus-min-btn">
                  <span class="min-btn" id="minus" onclick="price_hiding_out1('<?php echo $i+1; ?>');">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                  </span>
...
<?php } ?>
 ...
 <script type="text/javascript">
        ...
        <?php  if(count($patient_med)>0) {  $md1=count($patient_med)+1; for($i=$md1;$i<100;$i++){ ?>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <div class="col-md-4">
                <div class="disease-section">
                <label>Disease</label>
                     <select class="form-control select2" name="group[]" onchange="get_med(this.value,<?php echo $i; ?>)" id="group_<?php echo $i; ?>">
     <option value="">--Select Group--</option>
              ...
              <div class="col-md-7">
                <div class="disease-medicine-section-all">
                  <label>Disease Medicine</label>
                  <div class="all-disease-check-box-sec" id="get_des_med_<?php echo $i; ?>" style="min-height: 1px;overflow-y:scroll;max-height: 200px;">
                  </div>
                </div>
              </div>
              <div class="col-md-1">
                <div class="plus-min-btn">
                  <span class="min-btn" id="minus" onclick="edu_hiding_out(<?php echo $i; ?>);">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                  </span>
                  <span class="plus-btn" id="edu_no_<?php echo $i; ?>" onclick="edu_produce_file_box(<?php echo $i; ?>)">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                  </span>
                </div>
              </div>
...
<?php } ?>
     ...
     <?php if(count($my_med_without_group)>0)
     {
                                           for($i=0;$i<count($my_med_without_group);$i++)
                                            {

                                              ?>
        <div class="fourt-section-first-part" id="price_my_med_<?php echo $i+1;  ?>">
          <div class="col-md-9">
            <div class="fourth-medicine">
            <label>Medicine</label>
             <select class="form-control select2" name="my_medicine[]" id="my_medicine_0">
      <?php
          ...
          <div class="col-md-1">
            <div class="plus-min-btn">
                  <span class="min-btn" id="minus" onclick="price_hiding_out_my_med('<?php echo $i+1; ?>');">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                  </span>
...
<div class="all-gen-abd-chest-p-cus">
         ...
         <input type="text" class="form-control" name="gen_new" id="gen_new" multiple="" required="" placeholder="new General">
          ...
          <div class="col-md-6">
          <label>Chest</label>
         <input type="text" class="form-control" name="chest_new" id="gen_new" multiple="" required="" placeholder="new Chest">
          </div>
          <div class="col-md-6">
          <label>Heart</label>
          <input type="text" class="form-control" name="heart_new" id="abd_new" multiple="" required="" placeholder="new Heart">
          </div>
