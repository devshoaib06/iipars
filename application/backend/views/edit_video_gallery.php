        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Video Gallery Edit</h3>
            <div id="validation" style="color:red;"></div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/manage_video_category/edit_video_gallery_action" method="post" id="examination_add"  onsubmit="return log_val()" >
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="image" class="col-sm-2 control-label">Video Gallery Image (647 X 558) </label>
                  ...
                  <div class="col-sm-10">
                   ...
                   <?php
                                        if(@$edit_details[0]->video_gallery_image!="")
                                        {
                                            ?>
                                            <img id="prof_pic"
                                                 src="<?php echo base_url() ?>../assets/upload/gallery_image/<?php echo @$edit_details[0]->video_gallery_image; ?>"
