      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin_service/edit_examination_action" method="post" id="examination_add"  onsubmit="return log_val()" >
            <input type="hidden" value="<?php echo @$exam_data[0]->examination_id; ?>" name="exam_id">
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="examination_type" name="examination_type" required="">
                      ...
                      foreach ($examination_type as $row) { ?>
                         <option <?php if($row->examination_type_id==@$exam_data[0]->examination_type_id) { echo 'selected'; } ?> value="<?php echo $row->examination_type_id; ?>"><?php echo $row->examination_type; ?></option>
                      <?php } ?>
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="examination" required="" id="examination" class="form-control" placeholder="Service Name" value="<?php echo @$exam_data[0]->examination_name; ?>">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" onclick="return subAdminAdd()">Update</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
