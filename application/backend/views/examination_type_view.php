...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/sub_admin_list_manage/role_management">Service Type</a></li>
    ...
    <section class="content" style="margin-top: 12px;">
      ...
      <div class="box" style="padding: 12px;">
            ...
            <div class="box-header">
              <h3 class="box-title">Service Type(<?php  echo count($examination_type_list);?>)</h3><br><br>
                <span> <span class="btn btn-primary btn-sm" onclick="add_role_modal();">Add Service Type</span> </span> 
            ...
            <tr>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
               $sl = 0;
               foreach ($examination_type_list as $row) {
               ...
               ?>
                <tr>
                   <!--  <td><?php echo $sl++; ?></td> -->
                	 ...
                	 <td><input type="checkbox" name="record" value="<?php echo $row->examination_type_id;?>"></td>
                   <td>
                	...
                	<td><?php echo $row->examination_type; ?></td>
                	<!-- <td><?php  ?></td> -->
                	<td><?php echo date("d/m/Y", strtotime( $row->created_date )); ?></td>
                	<td>
                		
                       <a id="edit_role_btn_<?php echo $row->examination_type_id; ?>" class="btn btn-success btn-sm" title="Edit" href="javascript:void(0);" onclick="edit_examination_type(<?php echo $row->examination_type_id; ?>);">
                          <i id="edit_role_icon_<?php echo $row->examination_type_id; ?>" class="fa fa-pencil-square-o"></i>
                       </a>

                         <?php 
                              $exam_type=$this->admin_model->selectOne('tbl_examination','examination_type_id',$row->examination_type_id);
                        ...
                        ?>
                          ...
                          <a href="<?php echo base_url()?>index.php/admin_service/examination_type_delete/<?php echo $row->examination_type_id; ?>" class="btn-danger btn-sm" name="" id="" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                        <?php } ?>
      ...
      <div class="modal-header">
        ...
        <h3>Add Type</h3>
          ...
          <div class="modal-body">
              <div>
              <fieldset>   
                   <form action="<?php echo base_url(); ?>index.php/admin_service/add_examination_type_action" id="add_role_form" method="post">
                  <div class="control-group" id="edit_discount_control">
                     <label class="control-label" for="inputSuccess2">Service Type</label>
                     <div class="controls">
                       <input type="text" name="examination_type" id="examination_type" class="form-control" placeholder="" required=""  autocomplete="off">
                     <br> 
                     </div>
                  </div>
                  </form>
      ...
      <div class="modal-header">
        ...
        <h3>Edit Type</h3>
          ...
          <div class="modal-body">
              <div>
              <fieldset>   
                   <form action="<?php echo base_url(); ?>index.php/admin_service/edit_examination_type_action" id="edit_role_form"  method="post">
                  <div class="control-group" id="edit_discount_control">
       ...
       function change_sts_active(val)
        {
          //alert(val);
            ...
            if(pro_ids.length>0)
            {
              ...
              url:base_url+'index.php/admin_service/change_to_active_examination_type',
...
$.ajax(
    {   
        type: "POST",
        dataType:'json',  
        url:"<?php echo base_url();?>index.php/admin_service/edit_examination_type_json",  
