        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Service Data Add</h3>
            <div id="validation" style="color:red;"></div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/Admin_datalist/add_form_action" method="post" id="examination_add"  onsubmit="return log_val()" >
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" name="announce_date" id="announce_date" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" name="last_date" id="last_date" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" name="exam_date" id="exam_date" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" name="duration" id="duration" class="form-control">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" name="sponsor_by" id="sponsor_by" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" name="post" id="post" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" name="web_link" id="web_link" class="form-control">
