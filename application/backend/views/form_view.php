        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Service Data View</h3>
            <div id="validation" style="color:red;"></div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin_chamber/edit_form_action" method="post" id="examination_add"  onsubmit="return log_val()" >
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="university_type" name="university_type" readonly="" required="" onchange="get_uni(this.value)">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="university" name="university" required="" readonly="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="subject" name="subject" required="" readonly="">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="service_type" name="service_type" readonly="" required="" onchange="get_service(this.value)">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="services" name="services" required="" readonly="">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="state" id="state" readonly="" value="<?php echo @$form[0]->state; ?>" required="" class="form-control">
              ...
              <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Date of Announcement</label>

                  <div class="col-sm-10">
                   
                    <input type="date" required="" readonly="" name="announce_date" value="<?php echo @$form[0]->announce_date; ?>" id="announce_date" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" readonly="" value="<?php echo @$form[0]->last_announce_date; ?>" name="last_date" id="last_date" class="form-control">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" readonly="" name="title" id="title" value="<?php echo @$form[0]->title; ?>" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" readonly="" name="exam_date" id="exam_date" value="<?php echo @$form[0]->exam_date; ?>" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" readonly="" name="duration" id="duration" value="<?php echo @$form[0]->duration; ?>" class="form-control">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" readonly="" name="sponsor_by" id="sponsor_by" value="<?php echo @$form[0]->sponsor_by; ?>" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" readonly="" name="from_date" id="from_date" value="<?php echo @$form[0]->from_date; ?>" class="form-control">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="date" required="" readonly="" name="to_date" id="to_date"  value="<?php echo @$form[0]->to_date; ?>" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" readonly="" name="post" id="post" value="<?php echo @$form[0]->for_post; ?>" class="form-control">
                ...
                <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Pay Scale</label>

                  <div class="col-sm-10">
                   
                    <input type="text" required="" readonly="" name="amount" id="amount" value="<?php echo @$form[0]->amount; ?>" class="form-control">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" required="" readonly="" name="web_link" id="web_link"  value="<?php echo @$form[0]->web_link; ?>" class="form-control">
...
<input type="hidden" name="hidden_id" value="<?php echo @$form[0]->form_id; ?>">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/admin_chamber/form_list" class="btn btn-danger">Cancel</a>
...
<script type="text/javascript">
  function get_uni(val)
  {
    var base_url = '<?php echo base_url(); ?>';
      ...
      $.ajax({
        type: "POST",
        url: base_url+'index.php/admin_chamber/getuniversity',
        data:{id:val},
  ...
  function get_service(val)
  {
    var base_url = '<?php echo base_url(); ?>';
      ...
      $.ajax({
        type: "POST",
        url: base_url+'index.php/admin_chamber/getservice',
        data:{id:val},
        success: function(data){
         // console.log(data);
          var unilist = JSON.parse(data);
