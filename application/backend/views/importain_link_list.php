        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Link(<?php echo count($link); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <tr>
              ...
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_link/add_data" class="btn btn-primary btn-action" title="Add"><i class="fa fa-plus"></i> Add</a></td>
         ...
         <td> 
          <a href="<?php echo base_url();?>index.php/manage_link/edit/<?php echo $row->id;  ?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/manage_link/delete/'+id;
  }
}
