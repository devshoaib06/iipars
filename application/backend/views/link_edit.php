      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_link/edit_action" method="post" id="productadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Title<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="first_title" class="form-control" value="<?php echo @$link_details[0]->title ; ?>"  placeholder="Title"  id="first_title" >
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Link<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                      <div class="col-sm-9">
                        <input type="text" name="link" value="<?php echo @$link_details[0]->link ; ?>" class="form-control"  placeholder="Link"  id="link" >
                        <span id="f_ttle" style="color: red;"></span>

                        <input type="hidden" name="id" value="<?php echo @$link_details[0]->id ;?>">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_link" class="btn btn-danger">Cancel</a>
...
function readURL(input)
  ...
  function validate()
  {
      ...
      // var image= $('#image').val();
         ...
         if(link==''){
            $('#link').addClass('border-red');
            return false;
          }
       else {

                $('#link').removeClass('border-red');
       } 
