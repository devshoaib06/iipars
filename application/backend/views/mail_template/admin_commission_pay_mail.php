                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p >
                                  Dear Admin,
                                  Thank you for aproving the request of  Rs. <b><?php echo @$mail_data['request_amount']; ?></b> as commission from <?php echo @$mail_data['user_name']; ?></b>.Again thanks for making payment for the request.please wait for the feedback from publisher.
                                  Please check the details and give your feedback.
                                    
                                    <br>
                                    <br>
                                  To know more please visit Admin Account.
                                    <br>
                                    <br>
                                   Thanks and Regards,
                                    <br>
                                    <span style='color:#222222;'>Groce24</span>
                                  </p>
                                </div>
                              </div>
                            </td>
      ...
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                          <span style='font-weight:bold;'>Groce24</span>
                                          <br>
