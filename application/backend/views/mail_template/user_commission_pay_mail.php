...
<script type="colorScheme" class="swatch active">
{
    ...
    <tr>
      <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable">
                                  <p style='text-align:right;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">Payment from&nbsp;</span></span></p>
                                </div>
                              </div></td>
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable">
                                  <p style='text-align:left; margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#289CDC;'><span class="font">Coupon Monkey</span> </p>
                                </div>
                              </div></td>
    </tr>
  </tbody>
                          ...
                          <tr>
                            <td valign='top' align='center'>
                              <div class="contentEditableContainer contentImageEditable">
                                <div class="contentEditable">
                                  <img src="<?php echo base_url();?>../assets/img/email_img/line.png" width='251' height='43' alt='' data-default="placeholder" data-max-width="560">
                                </div>
                              </div>
                            </td>
                          </tr>
                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <h2 >Thank You <?php echo @$mail_data['user_name']; ?></h2>
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p >
                                  Dear <?php echo @$mail_data['user_name']; ?>,
                                  you have requested amount of Rs. <b><?php echo @$mail_data['request_amount']; ?></b> as commission.We are very happy to inform you that ur request has been approved.
                                  your requested amount has been paid by Coupon Monkey.Please check the details and give your feedback.
                                    
                                    <br>
                                    <br>
                                  To know more please visit your Coupon Monkey Account.
                                    <br>
                                    <br>
                                   Thanks and Regards,
                                    <br>
                                    <span style='color:#222222;'>Coupon Monkey</span>
                                  </p>
                                </div>
                              </div>
                            </td>
  ...
  <tbody>
    ...
    <tr><td height='25'> This is an auto generated email. Do not reply</td></tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                          <span style='font-weight:bold;'>Coupon Monkey</span>
                                          <br>
                                         2nd floor, Lalani Bauilding, 
                                         Chinarpark, Kolkata-700136. 
                                          <br>
  ...
  <tbody>
    <tr>
      <td  width='104' style="background-color:#000000" >
                                    <div class="contentEditableContainer contentFacebookEditable">
                                      <div class="contentEditable">
                                        <a target='_blank' href="<?php echo base_url();?>../"><img src="<?php echo base_url(); ?>assets/images/logo.png" width='104' height='60' alt='AbsTee' data-default="placeholder" data-max-width="104" data-customIcon="true"></a>
                                      </div>
                                    </div>
                                  </td>
