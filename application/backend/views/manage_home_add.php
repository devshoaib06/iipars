<script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
        ADD Welcome to IIPARS , Our Mission , Our Vission
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_home/insert" method="post" id="productadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
