<script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
        EDIT Welcome to IIPARS , Our Mission , Our Vission
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_home/edit_action" method="post" id="productadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Title<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="first_title" value="<?php echo $manage_home[0]->title; ?>" class="form-control"  placeholder="Title"  id="first_title" >
                  ...
                  <div class="col-sm-9">
                 <div id="pro_details">  <textarea type="text" name="content_details" class="form-control"  placeholder="Content details"  id="content_details"><?php echo $manage_home[0]->description; ?>
                     </textarea></div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="file" name="image" class="form-control"  id="image" value="<?php echo $manage_home[0]->image; ?>" onchange="readURL(this);">

                      <input type="hidden" name="id" value="<?php echo $manage_home[0]->id; ?>">

                      <input type="hidden" name="old_image" id="old_image" value="<?php echo @$manage_home[0]->image;?>" ><br>
                        

                      <img id="prof_pic" src="<?php echo base_url();?>../assets/upload/manage_home/<?php echo @$manage_home[0]->image; ?>" alt="no image" height="100px" width="100px" style="border-radius: 0%">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_home" class="btn btn-danger">Cancel</a>
