<div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
     MANAGE Welcome to IIPARS , Our Mission , Our Vission
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Content(<?php echo count($manage_home); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
                ...
                <img src="<?php echo base_url();?>../assets/upload/manage_home/<?php echo $row->image;  ?>"  alt="no image" height="60px" width="150px" style="border-radius: 0%">
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/manage_home/delete/'+id;
  }
}
