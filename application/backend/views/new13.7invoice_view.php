...
<?php if(@$data['user_detail'][0]->weight !=0 && @$data['user_detail'][0]->bmi != 0){ ?>
 ...
 <?php } ?>
    ...
    ?>
                <li style="padding: 8px;font-size: 20px; color: #222;padding-bottom: 10px; "><b><?php echo @$data['user_diagnosis'][0]->diagnosis_name; ?></b></li>
        ...
        <tr>
          ...
          <td style="vertical-align: top; ">
			  ...
			  <tr>
			    <td style="width: 240px;padding-bottom: 10px;"><p style="font-size: 22px;text-align: center;font-weight: bold;margin: 20px 0 10px;color: #000;">C/C :</p>
			    	<table>
			          <tr>
			            <th style="width: 50px;"></th>
			            <th style="text-align: left;">
        ...
        ?>
               ...
               foreach($data['cc'] as $row)
           {
            ...
            ?>
            <li style="padding: 8px;font-size: 20px; color: #222;padding: 10px; ">
         ...
         $data['kpo']=  $this->common->select($table_name='tbl_patient_kpo',$field=array(), $where=array('chk_history_id'=>$chk_history_id,'user_id'=>$user_id), $where_or=array(),$like=array(),$like_or=array(),$order=array(),$start='',$end='');
          ...
          ?>
             ...
             <li style="padding: 8px;font-size: 20px; color: #222;padding-bottom: 10px; "><?php echo @$data['user_kpo'][0]->kpo_name; ?></li>
            <?php } } ?>	</ul>
				            </th>
				        </tr>
				      </table>
         ...
         { ?>
          ...
          ?>
            ...
            <li style="padding: 8px;font-size: 20px; color: #222;padding: 10px; "><?php echo @$data['user_ho'][0]->ho_name; ?> - <?php echo @$row->day_id; ?></li><br>
 <?php } } ?> </ul>
		            </th>
		        </tr>
		      </table>
     ...
     if(count($data['gen_exam'])>0)
     {
      ?>
			    <td colspan="2" style="width:80px;padding-bottom: 10px;">
			    	...
			    	<table>
				          <tr>
				            <th style="width: 90px;text-align: left;"><p style="font-size: 20px; color: #222;"><b style="">General </b></p></th>
				            <th style="text-align: left; font-size: 20px; color: #555;font-weight: 100;"> :
				            	<?php
...
<?php $result .=@$data['exam'][0]->examination_name.','; $result = rtrim($result,','); echo $result; ?>
 <?php } } ?><br>
				            ...
				            <th style="text-align: left; font-size: 20px; color: #555;font-weight: 100;"></th>
				        </tr>
				      </table>
			  ...
			  <tr>
			    ...
			    <td colspan="2" style="width: 10px;padding-bottom: 10px;">
			    	...
			    	<table>
				          <tr>
				            <th style="width: 90px;text-align: left;"><p style="font-size: 20px; color: #222;"><b>BP</b></p></th>
				            <th style="text-align: left; font-size: 20px; color: #555;font-weight: 100;">
				              <p > : <?php echo @$prescription[0]->bp_upper; ?>/<?php echo @$prescription[0]->bp_lower; ?> mm of Hg<?php } ?> ,</p>
				            </th>
				             <th style="width: 70px; text-align: left;"><p style="padding: 0px 8px 8px;font-size: 20px; color: #222;padding: 0px 10px 10px;"><b>Pulse</b></p></th>
				             <th style="text-align: left; font-size: 20px; color: #555;font-weight: 100;">
				             	<?php if(@$prescription[0]->pulse != "" || @$prescription[0]->pulse != 0){ ?>
				             		<p>: <?php echo @$prescription[0]->pulse; ?>/min <?php echo @$prescription[0]->pulse_type; ?></p><?php } ?><br>
				             </th>
				        </tr>
				      </table>
     ...
     ?>
			    <td colspan="2" style="width: 10px; padding-bottom: 10px;">
			    	<table>
			          <tr>
			            <th style="width: 90px;text-align: left;"><p style="padding: 8px;font-size: 20px; color: #222;padding: 10px;"><b style="width: 100px;">Chest </b></p></th>
			            <th style="text-align: left; font-size: 20px; color: #555;font-weight: 100;">
			            	: <?php 
...
$result1 .=@$data['exam_chest'][0]->examination_name.','; $result1 = rtrim($result1,','); echo $result1;
     ...
     ?>
			    <td style="width: 10px;padding-bottom: 10px;">
			    	<p style="padding: 8px;font-size: 20px; color: #222;padding: 10px;">
              		<b style="padding-right: 100px;">Heartxx </b></p>  
...
<?php 
 ...
 ?>
            <li style="padding: 8px;font-size: 20px; color: #222;padding: 10px;line-height: 20px;"><?php echo @$data['user_inves'][0]->investigation_name; ?></li>
...
<p style="font-size: 22px;text-align: center;font-weight: bold;margin: 20px 0 10px;color: #000;">
     ...
     ?>
          <p style="font-size: 22px;text-align: center;font-weight: bold; padding: 20px 0 10px;color: #000;">Diet:</p>
          <p></p>
          <ul>
...
<?php
 ...
 ?>
          <li style="padding: 8px;font-size: 20px; color: #222;padding: 10px;">  <?php echo @$data['user_diet'][0]->diet_name; ?></li>
...
if(count($data['coun'])>0)
{
     ...
     ?>
          <p style="font-size: 22px;text-align: center;font-weight: bold;padding: 20px 0 10px;color: #000;">Counselling : </p>
          <p></p>
          <ul>
<?php
 ...
 ?>
          ...
          <li style="padding: 8px;font-size: 20px; color: #222;padding: 10px;">  <?php echo @$data['councelling'][0]->councelling_name; ?> </li>
