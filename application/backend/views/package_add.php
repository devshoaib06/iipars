      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_package/insert" method="post" id="productadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Package Title<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="first_title" class="form-control"  placeholder="Package Title"  id="first_title" >
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Package Price<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="price" class="form-control"  placeholder="Package Price"  id="price" >
                        <span id="f_ttle" style="color: red;"></span>
