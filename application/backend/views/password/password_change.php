      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Pasword Update
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" action="<?php echo base_url();?>index.php/profile/profile_update" method="post"
            id="profileedit_form_validation">
            <div class="box-body">
              <div class="form-group">
                <label for="inputName" class="col-sm-2 control-label">New Password </label>

                <div class="col-sm-8">
                  <input type="text" name="f_name" id="f_name" class="form-control" id="inputName" placeholder="New Password"
                    value="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="lst_name" id="lst_name" class="form-control" id="inputName"
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-info pull-right"
                onclick="return exequete_profileedit_form_validation()">Update</button>
            </div>
            <!-- /.box-footer -->
          </form>
        </div>
