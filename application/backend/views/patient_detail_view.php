...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>DETAILS OF  <?php echo @$user_patient[0]->first_name." ".@$user_patient[0]->last_name; ?> (<?php echo @$user_patient[0]->user_unique_id;?>)</h1>
        <ol class="breadcrumb">
                        ...
                        <div class="tab-content">
                                ...
                                <div id="vital_info" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="first_name" readonly="" value="<?php echo @$user_patient[0]->first_name; ?>" id="first_name" placeholder="First Name" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                              <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="last_name" readonly="" value="<?php echo @$user_patient[0]->last_name; ?>" id="last_name" placeholder="Last Name" style="margin-bottom:12px" >
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <!--   <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="email" name="email" onkeyup="email_check(value)" readonly="" id="email" value="<?php echo @$user_patient[0]->login_email; ?>" placeholder="Email" style="margin-bottom:12px" >
                                         ...
                                         <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="mobile" readonly="" value="<?php echo @$user_patient[0]->mobile; ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="mobile" maxlength="11" style="margin-bottom:12px" placeholder="Mobile No">
                                            </div>
                                        </div>
                                         ...
                                         <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="age" readonly="" id="age" value="<?php echo @$user_patient[0]->age; ?>" style="margin-bottom:12px" placeholder="Age">
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input  type="radio" name="gen" id="gen" value="male" style="margin-bottom:12px" <?php if(@$user_patient[0]->gender=='Male') { echo 'checked'; } ?>>Male
                                                  <input type="radio" name="gen" id="gen" value="female" <?php if(@$user_patient[0]->gender=='Female') { echo 'checked'; } ?> style="margin-bottom:12px" >Female
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            <label for="product_name" class="col-sm-2 control-label">Weight (in Kg.)</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="weight" readonly="" value="<?php echo @$user_patient[0]->weight; ?>" id="weight" style="margin-bottom:12px" placeholder="Weight">
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            <label for="product_name" class="col-sm-2 control-label">Height (in m)</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="height" readonly="" value="<?php echo @$user_patient[0]->height; ?>" id="height" style="margin-bottom:12px" placeholder="Height">
                                            </div>
                                        </div> 
                                         ...
                                         <div class="clearfix"></div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="height" readonly="" value="<?php echo @$user_patient[0]->bmi; ?>" id="height" style="margin-bottom:12px" placeholder="Height">
                                            </div>
                                        </div> 
