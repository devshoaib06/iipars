<script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
       MANAGE PHD THESIS TO BOOK CONVERSION GENERAL GUIDELINE
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_phd_thesis_guideline/insert" method="post" id="welcome_content_form" enctype="multipart/form-data">
              <div class="box-body">
