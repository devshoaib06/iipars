         ...
         $user_detail=  $this->common->select($table_name='tbl_user',$field=array(), $where=array('user_id'=>$row->user_id), $where_or=array(),$like=array(),$like_or=array(),$order=array(),$start='',$end='');
              ...
              ?>
                ...
                <?php echo $i; ?>
                   ...
                   <td>  <?php echo @$user_detail[0]->city; ?></td> 
                  <td>  <?php echo $row->created_date; ?></td>  
                  <td>  <?php echo $row->check_next_date; ?></td> 
                	<td> 

                    <a  class="btn btn-success btn-sm" title="Edit" href="<?php echo base_url(); ?>index.php/admin_user/edit_patient_prescription/<?php echo  @$user_detail[0]->user_id; ?>/<?php echo @$row->chk_history_id; ?>">
