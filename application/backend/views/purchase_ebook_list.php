        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Purchased E-Book(<?php echo count($ebook_purchase); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <?php } ?> -->
              ...
              <span style="padding-left: 85%">
                ...
                <!-- <a href="<?php echo base_url();?>index.php/manage_ebook/csv_ebook_purchased" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i>Export CSV</a> -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
                ...
                <?php echo @$ebook[0]->title; ?>
                </td>
                <td>
                
                <img style="height: 65px; width: 85px;" src="<?php echo base_url(); ?>../assets/upload/ebook/resize/<?php echo @$ebook[0]->image; ?>">
                </td>

                <td><?php echo @$ebook[0]->price; ?></td>
                
                
                <td><?php echo @$buyer_name[0]->first_name; ?></td>
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/manage_ebook/delete_purchased_ebook/'+id;
  }
}
