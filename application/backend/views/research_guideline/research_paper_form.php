    ...
    <section class="content-header">
     ...
     Research Paper Consultany
      ...
      <ol class="breadcrumb">
        ...
        <li>Research Paper Consultany</li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Research Paper Consultany(<?php echo count($research_consul); ?>)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <?php } ?> -->
              ...
              <span style="padding-left: 85%">
                ...
                <a href="<?php echo base_url();?>index.php/manage_research_guideline/export_csv_research_paper_list" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i>Export CSV</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr class="bg-blue">
                  ...
                  <th>Subject</th>
                  <th>Designation</th>
                  <th>Subject for Research Paper</th>
                  <th>Specialisation</th>
                  <!-- <th>M.Phil/ Ph.d Title(if any)</th>
                  <th>No of Paper Order</th>
                  <th>In Words</th>
               ...
               <?php
                $i=0;
                foreach($research_consul as $row)
                {
                  $i++;
               ...
               <!--  <td><?php echo $row->mphil; ?></td>


                <td><?php echo $row->nopaper; ?></td>
                <td><?php echo $row->in_words; ?></td>
                <td><?php echo $row->total_amount ; ?></td>
                <td><?php echo $row->t_amount_words ; ?></td> -->
         ...
         <td> 
          ...
          <!-- <a href="<?php echo base_url();?>index.php/manage_research_guideline/export_csv_research_paper_list/<?php echo $row->id; ?>" class="btn btn-primary action-button btn-action" title="CSV"><i class="fa fa-download"></i></a> -->
...
function delete_data(id)
{
  ...
  window.location=baseurl+'index.php/manage_research_guideline/delete/'+id;
  }
}
