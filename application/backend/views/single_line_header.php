      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin_contact/single_line_update" method="post" id="contact_add_form_validation" >
              <div class="box-body">
              ...
              <!--   <div class="form-group">
				...
				<div class="form-group">
                  <label for="contact_no" class="col-sm-2 control-label"><center>Title : <span style="color:#F00"></span> </center></label>

                  <div class="col-sm-8">
                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter Some Text "  value="<?php echo @$header_title[0]->title; ?>">
