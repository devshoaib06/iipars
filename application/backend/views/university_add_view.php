        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Institute Add</h3>
            <div id="validation" style="color:red;"></div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin_service/add_examination_action1" method="post" id="examination_add"  onsubmit="return log_val()" >
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control select2" id="subject_id" name="subject_id[]" multiple="multiple" data-placeholder="--Select Subjects--">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="examination" required="" id="examination" class="form-control" placeholder="Institute Name" >
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="website_address"  id="website" class="form-control" placeholder="Website Link" >
