          ...
          <div class="box">
            ...
            ?>
                  ...
                  <td>
                     ...
                     <a href="<?php echo base_url();?>index.php/admin_service/university_wise_subject/<?php echo $row->university_id;?>" class="btn btn-success" title="Subject"><i class="fa fa-list" aria-hidden="true"></i></a>
