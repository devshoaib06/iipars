      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/Manage_social_site/visitor_update" method="post" id="productadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                  ...
                  <div class="form-group" >
                    <label for="product_title" class="col-sm-2 control-label">Visitor<span style="color: rgb(255, 0, 0); padding-left: 2px;"></span></label>

                      <div class="col-sm-9">
                        <input type="text" name="visitor" value="<?php echo $visitor[0]->count; ?>" class="form-control"  placeholder="Title"  id="visitor" >
                  ...
                  <input type="hidden" name="hidden_id" value="<?php echo $visitor[0]->id; ?>" class="form-control" >
