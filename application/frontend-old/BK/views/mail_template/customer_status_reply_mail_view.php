...
<head>
	...
	<title>Reply From DSY apnabazzar </title>
	...
	<style type="text/css">
        ...
        */
		#templateUpperBody{
			/*@editable*/background-color:#6DC6DD;
			/*@editable*/border-top:0;
			/*@editable*/border-bottom:0;
		}
		/*
			...
			<td align="center" valign="top" id="bodyCell" style="padding-bottom:40px;">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
																...
																<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
																	<tbody><tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="<?php echo base_url(); ?>../assets/images/logo2.png" width="250" style="max-width:369px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
					...
					<tr>
						<td align="center" valign="top">
							<!-- BEGIN LOWER BODY // -->
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateLowerBody">
								<tr>
									<td align="center" valign="top">
										<table border="0" cellpadding="0" cellspacing="0" width="600" class="templateContainer">
											<tr>
												<td valign="top" class="lowerBodyContainer" style="padding-top:10px; padding-bottom:10px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width:100%;">
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																			...
																			<h3><!-- em>Dear <?php echo @$mail_data['fname'].' '.@$mail_data['lname']; ?>,</em><br><em>
																				
																					Your registered Email Id is <?php  echo @$mail_data['uemail'];  ?> and Phone number is  <?php echo @$mail_data['uphone'];  ?>.

																			</em> --><br>
																				<!-- <em>You have ordered a <b><?php echo @$mail_data['product_name']; ?></b></em> --> <!-- on
																				<em><?php echo date('d',strtotime($mail_data['uorder_date'])); ?><?php echo date('M',strtotime($mail_data['uorder_date'])); ?>
																				<?php echo date('Y',strtotime($mail_data['uorder_date'])); ?> -->
																					
																				</em><br>
																				Your Order Id is
																				<em><?php echo @$mail_data['uorder_id']; ?></em>, for the product <em><b><?php echo @$mail_data['product_name']; ?></b></em>,

																					<?php 

																				if(@$mail_data['ustatus']!='Order_Taken')
																				{
																					?> Your product has been <em><?php echo @$mail_data['ustatus']; ?></em> successfully. <?php } 
																				 

																				 else
																				  {

																				 	?> Your <b>order</b> has been successfully <b>taken</b>.
