...
<a href=""><img src="<?php echo base_url();?>assets/images/logo.png" style="max-width:369px;" alt="DSY apnabazzar" class="img-responsive"></a>
<div style="height:90px;width:10px;"></div>
<div>
	<table>
		<tr>
			<td colspan="7">Dear <?php echo @$mail_data['first_name'].' '.@$mail_data['last_name']; ?>,</td>
		</tr>
		<tr>
			<td colspan="7">Your order has been placed form your DSY apnabazzar account on <?php echo date('d-m-Y', strtotime(@$mail_data['order_date']));?>. Details are given bellow</td>
		</tr>
	</table>
	<table border="1">
		...
		foreach(@$mail_data['order_details'] as $row)
		{
			...
			//$seller_contact= $this->home_model->selectOne('tb_seller_contact','seller_id',$row->order_product_seller_id);
		...
		<tr>
			...
			<img src=<?php echo base_url();?>assets/upload/product/<?php echo @$pro_image[0]->image;?> height="100px" width="100px"></td>
			...
			<td>
			<?php if(@$pro_desc[0]->user_type_id=='2'){ ?>
