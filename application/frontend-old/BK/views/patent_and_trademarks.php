...
<div class="body-content">
	...
	<h2 class="heading-title tc-titel">Terms and Conditions</h2>
	<div class="">
		...
		<h3>Contact Us</h3>
		<p>If you have any questions about this Agreement, please contact us filling this <a href="contactus.php" class='contact-form'>contact form</a></p>
	</div>
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
