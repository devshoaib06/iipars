                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                       <!--  <div class="myaccount-widget">
                           ...
                           <h4 class="bp-head">Add New Product</h4>
                           <?php
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
       <div class="col-md-12">
                           ...
                           <form method="post" action="<?php echo base_url(); ?>seller_bussiness_profile/add_seller_product_action" enctype="multipart/form-data">
                           ...
                           <div class="row" id="bp-mar">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                             ...
                                             <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                                <select class="form-control" name="category" id="category" style="margin-bottom:12px" required="">
                                                <option value="">Select Product Category</option>
                                                 <!-- <?php foreach($category as $cat)
                                                     ...
                                                     $sub = $this->common_model->common($table_name = 'tbl_category', $field = array(), $where = array('category_id'=>$sub_cat), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
                                                      ...
                                                      <option value="<?php echo $cat->category_id;?>"><?php if($parent_cat>0){ echo @$parent[0]->category_name." > "; } ?><?php if($sub_cat>0){ echo @$sub[0]->category_name." > "; } ?><?php echo $cat->category_name; ?></option>
                                                                                                  <?php 
                           ...
                           <div class="row" id="bp-mar">
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Product Title" name="product_name" id="product_name" onkeyup="catname(this.value)"  class="bp-bx" required="">
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                     ...
                                     <div class="row" id="bp-mar">
                                        ...
                                        <label>Brand<sup><i class="fa fa-star" id="font-sz"></i></sup></label> 
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                                <select class="form-control" name="brand" id="brand" style="margin-bottom:12px" required="">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Product Weight ( in gm)" name="weight" id="weight"  class="bp-bx" required="">
                                    </div>
                                    </div>
                                      ...
                                      <div class="row" id="bp-mar">
                                        ...
                                        <label>Product image<sup><i class="fa fa-star" id="font-sz"></i></sup></label> 
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                                <input class="form-control" type="file" name="image[]" id="image" style="margin-bottom:12px" >(Resolution: 317 X 317)
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Product SKU" name="sku" class="bp-bx">
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Product price" name="price" class="bp-bx" required="">
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Product  discount" name="discount" class="bp-bx" required="">
                                    </div><div> % </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                   ...
                                   <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                        <label>Manufacture Date<sup><i class="fa fa-star" id="font-sz"></i></sup></label> 
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                                <input type="text" class="form-control pull-right"  name="manufactured_date" id="manufactured_date" required="">
                                   ...
                                   <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                        <label>Expiry Date<sup><i class="fa fa-star" id="font-sz"></i></sup></label> 
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                                <input type="text" class="form-control pull-right" name="expiry_date" id="expiry_date" required="">
                                                <!-- <i class="fa fa-calendar form-control-feedback" style="margin-right:20px"></i> -->
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        ...
                                        <textarea  type="text" placeholder="" name="product_description" class="bp-bx" cols="60" rows="5" required=""></textarea>
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Meta Title" name="meta_title" class="bp-bx" >
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        <input type="text" placeholder="Meta Keyword" name="meta_key" class="bp-bx" r>
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                                        ...
                                        <textarea  type="text" placeholder="Meta Description" name="meta_description" class="bp-bx" cols="60" rows="5" ></textarea>
                                    </div>
                                    </div>
