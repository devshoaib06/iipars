...
class Manage_self_book_publication extends CI_Controller 
{	
	...
	public function index()
	{
		...
		$this->load->view('self_book_publication_view',$data);
...
$data['page_title']= 'Book Writing Consultancy';
        ...
        $data['manage_home']=$this->admin_model->selectAll('tbl_research_guideline');
		 ...
		 $this->load->view('common/header');
		$this->load->view('book_writing_consult',$data);
		$this->load->view('common/footer');
	}


public function publication_consultacy()
	{

$data['page_title']= 'Book Publication Consultancy';
        ...
        $data['manage_home']=$this->admin_model->selectAll('tbl_research_guideline');
		 ...
		 $this->load->view('common/header');
		$this->load->view('book_public_consult',$data);
		$this->load->view('common/footer');
	}
	public function thesis_publication()
	{

$data['page_title']= 'Thesis to Book Publication';
        ...
        $data['manage_home']=$this->admin_model->selectAll('tbl_research_guideline');
		 ...
		 $this->load->view('common/header');
		$this->load->view('thesis_publication',$data);
		$this->load->view('common/footer');
	}


	public function dissertation_publication()
	{

$data['page_title']= 'M.Phil. Dissertation to Book Publication';
        ...
        $data['manage_home']=$this->admin_model->selectAll('tbl_research_guideline');
		 ...
		 $this->load->view('common/header');
		$this->load->view('mphil_book_publication',$data);
		$this->load->view('common/footer');
	}
...
$data['page_title']= 'Project Work to Book Publication';
        ...
        $data['manage_home']=$this->admin_model->selectAll('tbl_research_guideline');
		 ...
		 $this->load->view('common/header');
		$this->load->view('project_book_publication',$data);
		$this->load->view('common/footer');
	}
...
$data['page_title']= 'Research Paper Publication Consultanc';
