        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-9 text-ali-rt text-ce-res">
			...
			<div class="hed-cont widget mt-10 mb-10 m-0 res-none">
				<a class="btn mt-10 trans-btn" href="#"><i class="fa fa-lg fa-envelope-o" aria-hidden="true"></i><?php echo @$contact[0]->primary_email; ?></a>
			...
			<div class="hed-cont widget mt-10 mb-10 m-0 res-none">
				<a class="btn mt-10 trans-btn" href="#"><i class="fa fa-lg fa-mobile" aria-hidden="true"></i><?php echo @$contact[0]->contact_no; ?></a>
          ...
          // print_r($login_avail);
            ...
            ?>
			 <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
				<a class="btn mt-10 trans-btn" href="<?php  echo $this->url->link(2);?>"><i class="fa fa-sign-in" aria-hidden="true"></i>Login</a>
            ...
            <ul class="menuzord-menu">
              ...
              <li ><a href="#">Service</a>
                <ul class="dropdown">
                  ...
                  <li><a href="<?php echo base_url();?>Manage_research/writing_consultancy">Research Paper Writing Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_research/paper_publication">Research Paper Publication Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_phd">Ph. D. Thesis writing Consultancy</a></li>
                    <!-- <li><a href="<?php echo base_url();?>Manage_research/synopsis_writing">Synopsis Writing Consultancy</a></li> -->
                    <li><a href="<?php echo base_url();?>Manage_research/mphil_dissertation">M.Phil. Dissertation writing Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_research/project_work">Project Work Writing Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_research/data_analysis">Data Analysis & Research Methodology</a></li>
                    <!-- <li><a href="<?php echo base_url();?>Manage_research/pliagiarism_checking">Plagiarism Checking </a></li> -->
                    <li><a href="<?php echo base_url();?>Manage_research/project_work_book">Project Work to Book Publication  </a></li>
                ...
                <li ><a href="<?php echo base_url();?>Manage_self_book_publication">Book Publication</a>
                    <ul class="dropdown">
                     ...
                     <li><a href="<?php echo base_url();?>Manage_self_book_publication/writing_consultancy">Book Writing Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_self_book_publication/publication_consultacy">Book Publication Consultancy</a></li>
                    <li><a href="<?php echo base_url();?>Manage_self_book_publication/thesis_publication">Thesis to Book Publication</a></li>
                    <li><a href="<?php echo base_url();?>Manage_self_book_publication/dissertation_publication">M.Phil. Dissertation to Book Publication</a></li>
                    <li><a href="<?php echo base_url();?>Manage_self_book_publication/project_work_book">Project Work to Book Publication</a></li>
