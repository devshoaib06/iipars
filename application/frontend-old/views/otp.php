  ...
  <div class="main-content">
    ...
    <section class="log-sec">
		<div class="container">
			<div class="log-wrap">
				<h2>OTP</h2>
				<p style="color:green"><b><?php echo $this->session->flashdata('err_msg');?></b></p>


				<div class="form-wrap">
					<form method="POST" action="<?php echo base_url();?>sign_up/final_create_account"  id="client_registration_form" enctype="multipart/form-data">
            ...
            <div class="col-lg-12">
              <div class="form-group">
                <input type="text" class="input-box" name="otp" id="otp" placeholder="Put the OTP here">
					...
					<!-- 	<div class="col-lg-12">
						...
						<div class="srv-btn">
							<button type="submit" class="otppagebtnpcus">Submit</button>
						</div>
					</form>
				</div>
			</div>
