  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-white-8" data-bg-img="<?php echo base_url();?>assets/images/vdo-gall-bg.jpg">
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            ...
            <?php foreach($video_gallery_category as $key=>$cat) { ?>
                 <a href="#<?php echo $cat->video_category_id; ?>"  data-filter=".<?php echo $cat->video_category_id; ?>"><?php echo $cat->video_category; ?></a>
               <?php } ?>  
              ...
              <div id="grid" class="gallery-isotope default-animation-effect grid-4 gutter clearfix">
                ...
                <?php foreach($video_gallery as $key=>$row) { ?>
                <div class="gallery-item <?php echo $row->video_category_id;?>">
                  <div class="thumb">
                    <img class="img-fullwidth" src="<?php echo base_url();?>assets/upload/gallery_image/<?php echo $row->video_gallery_image;?>" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a class="popup-youtube" href="<?php echo $row->video_gallery_link; ?>"><i class="fa fa-youtube-play"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
