          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm mega-menu"> <a href="#" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Categories 1<!-- <span class="caret" id="rgt-cnt1"></span> -->
                      ...
                      <div class="yamm-content ">
                        <div class="row">
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            ...
                            <ul class="links">
                             <li><a href="category.php">Categories1</a></li>
                              <li><a href="category.php">Categories2</a></li>
                              <li><a href="category.php">Categories3</a></li>
                              <li><a href="category.php">Categories4</a></li>
                              <li><a href="category.php">Categories4</a></li>
                              <li><a href="category.php">Categories5</a></li>
                              <li><a href="category.php">Categories6</a></li>
                            </ul>
                          </div>
                          <!-- /.col -->
                          
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">sub Categorie</h2>
                            <ul class="links">
                             <li><a href="category.php">Categories1</a></li>
                              <li><a href="category.php">Categories2</a></li>
                              <li><a href="category.php">Categories3</a></li>
                ...
                <a href="#"  data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Catagories<!-- <span class="caret" id="rgt-cnt1"></span> --><span id="plus"><i class="fa fa-plus" aria-hidden="true"></i></span>
                <span id="plus1"><i class="fa fa-minus" aria-hidden="true"></i></span></a>
                  <ul class="dropdown-menu container">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="<?php echo base_url(); ?>assets/images/banners/banner-side.png"></a> </div>
                        </div>
                        <!-- /.row --> 
                      </div>
                      <!-- /.yamm-content --> </li>
