...
class admin_model extends CI_Model
{
    ...
    function distict_service($table)
    {
        $this->db->distinct(); 
    ...
    function get_average_review($table_name,$column_name,$id)
    {
    ...
    function sum_of_beds_rooms($table_name,$id)
    {
        $this->db->select_sum('no_of_beds');
        $this->db->select_sum('no_of_bathrooms');
        // $this->db->select('rating');
        $this->db->from($table_name);
