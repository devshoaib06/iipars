					...
					<div class="container-fluid p-0">
					  ...
					  style="z-index: 5;background-color:rgba(0, 0, 0, 0.35);border-color:rgba(0, 0, 0, 1.00);"> 
										...
										<div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
											...
											data-mask_out="x:0;y:0;s:inherit;e:inherit;" data-start="1000"
											data-splitin="none" data-splitout="none" data-responsive_offset="on"
											style="z-index: 7; white-space: nowrap;"><?php echo $row->second_title;?>
...
<div class="news_sec">
	...
	<section class="course-highlight">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<a href="<?= $this->config->item('base_teach_url');?>">
				...
				<div class="col-sm-6">
					<a href="<?php echo base_url();?>cms/writing_consultancy_all">
						<div class="ugc-csir-courses">
