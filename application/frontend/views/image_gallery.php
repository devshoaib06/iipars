          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <ol class="breadcrumb text-center text-black mt-10">
                <li><a href="#">Home</a></li>
                <li class="active text-theme-colored">Image Gallery</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          ...
          <!--       <a href="#" class="active" data-filter="*">All</a>
              ...
              <div id="grid" class="gallery-isotope default-animation-effect grid-4 gutter clearfix">
                ...
                $image_gallery = $this->common->select($table_name='tbl_image_gallery',$field=array(), $where=array('video_category_id'=>$img->video_category_id), $where_or=array(),$like=array(),$like_or=array(),$order=array(),$start='',$end='');
               ...
               <div class="gallery-item <?php echo $main_img->video_category_id; ?>">
                  <div class="thumb">
                    <img class="img-fullwidth" src="<?php echo base_url();?>assets/upload/gallery_image/resize/<?php echo $main_img->video_gallery_image; ?>" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                      <a href="<?php echo base_url();?>assets/upload/gallery_image/<?php echo $main_img->video_gallery_image; ?>" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <!-- <div class="gallery-item branding">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                        <a href="<?php echo base_url();?>assets/images/gallery/1.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
