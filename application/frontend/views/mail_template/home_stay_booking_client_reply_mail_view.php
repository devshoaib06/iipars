...
<tr>
				<td  style="  font-size: 14px; line-height: 22px; text-align:justify;"><p style="padding: 0; margin: 0;"> <p>Congratulations! You have successfully booked the Home Stay <strong>"<?php echo @$mail_data['hotel_name']; ?>"</strong> .Our team will contact you as soon as possible.<br/><br/>
