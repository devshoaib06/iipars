...
<table style="width: 100%; float: left; box-sizing: border-box;" cellpadding="0" cellspacing="0">
		<tr>
				<td style=" background: #0095da; padding: 12px 0; font-size: 20px; font-weight: 700; text-transform: uppercase; text-align: center; color: #fff;">New Package Booking!
			</td>
			</tr>
		</table>	
	...
	<tr>
		<td>
			...
			<table style="width: 100%; float: left; padding: 10px 0 0;">
				<tr>
				<td style=" font-size: 14px; vertical-align: top; line-height: 22px; text-align:left; float:left;"><p style="padding: 0; margin: 0;">Dear <?php echo @$mail_data['clientname']; ?>,
 </p></td>
</tr>
<tr>
				<td  style="  font-size: 14px; line-height: 22px; text-align:justify;"><p style="padding: 0; margin: 0;"> <p>Congratulations! You have successfully booked the Package <strong>"<?php echo @$mail_data['hotel_name']; ?>"</strong> .Our team will contact you as soon as possible.<br/><br/>
...
<strong>Booking Details:
            ...
            <table style="width: 100%; float: left; ">
                <tr>
                    <td>
                        <ul>
                            ...
                            <li><strong style=" font-size: 14px; vertical-align: top; line-height: 22px;    color: #0095da; width: 250px; text-align:left; float:left;">Package Name</strong> 
                ...
                <?php echo @$mail_data['hotel_name']; ?></span></li>
                             ...
                             <li><strong style=" font-size: 14px; vertical-align: top; line-height: 22px;    color: #0095da; width: 250px; text-align:left; float:left;">Package Type</strong> 
                                <span style=" font-size: 14px; vertical-align: top; line-height: 22px; text-align:left; float:left;">
