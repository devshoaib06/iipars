    ...
    <section class="breadcamp">
      ...
      <div class="container">
        ...
        <ul>
          ...
          <li class="active text-theme-colored"><?php if(!empty($page_detl->title)){echo $page_detl->title ;}?></li>
      ...
      <div class="container ">
        ...
        <div class="row d-flex">
          ...
          <div class="col-sm-8">
            ...
            <h1 class="mt-0"><?php if(!empty($page_detl->title)){echo $page_detl->title ;}?></h1>

            <?php if(!empty($page_detl->sub_title)){ ?>
          ...
          <?php }?>
            ...
            <div class="cms-content">
              ...
              <?php if(!empty($page_detl->content)){echo $page_detl->content ;}?>
