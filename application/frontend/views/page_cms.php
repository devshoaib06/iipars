    ...
    <section class="breadcamp">
      ...
      <div class="container">
        ...
        <ul>
          ...
          <li class="active text-theme-colored"><?php if(!empty($page_detl->page_title)){echo $page_detl->page_title ;}?></li>
      ...
      <div class="container ">
        ...
        <div class="row d-flex">
          ...
          <div class="col-sm-8">
            ...
            <h1 class="mt-0"><?php if(!empty($page_detl->page_title)){echo $page_detl->page_title ;}?></h1>

            <?php if(!empty($page_detl->page_headline)){ ?>

            <blockquote class="quot">
              <?php echo $page_detl->page_headline ;?>
            </blockquote>
          ...
          <?php }?>
            ...
            <div class="cms-content">
              ...
              <?php if(!empty($page_detl->page_content)){echo $page_detl->page_content ;}?>
