<!-- Start main-content -->
  <div class="main-content">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title">PHD Thesis to book Conversion General Guideline</h2>
              <ol class="breadcrumb text-center text-black mt-10">
                <li><a href="#">Home</a></li>
                <li class="active text-theme-colored">General Guideline</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <!-- <iframe width="100%" height="100px" src="https://www.youtube.com/embed/EPaeCZWbLDI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
 ...
 <!--    <p>
    ...
    <div class="apply_online_submission_btn">
      <a class="btn hvr-bounce-to-bottom btn-theme-colored" href="<?php echo base_url();?>Manage_phd/apply_form">Apply Online Submission</a>
    </div>
