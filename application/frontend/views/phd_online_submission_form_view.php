        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title">PHD Thesis Online Submission Form</h2>
              <ol class="breadcrumb text-center text-black mt-10">
                <li><a href="#">Home</a></li>
                <li class="active text-theme-colored">PHD Thesis Online Submission Form</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">          
          <div class="row">
            ...
            if($succ_msg){
              ...
              <!-- Contact Form -->
              <form id="contact_form" name="contact_form" class="contact-form-transparent" action="<?php echo base_url(); ?>manage_phd/phd_thesis_submit" method="post">
                <div class="row">
                  <div class="col-sm-6">
           ...
           <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input name="thesis_title" id="book_title" class="form-control" type="text" placeholder="Enter Thesis Title">
                    </div>
                  </div>
                   <div class="col-sm-12">
  ...
  function validate()
  {
      ...
      var short_description= $('#short_description').val();
         ...
         if(subject==''){
            ...
            if(book_title==''){
            $('#book_title').addClass('border-red');
            return false;
          }
       else  {

                $('#book_title').removeClass('border-red');
       }
