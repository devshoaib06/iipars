<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Video Gallery List</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Video Gallery(<?php echo count($vedio_gallery_list ); ?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_video_category/add_video_gallery" class="btn btn-primary btn-action" title="Add"><i class="fa fa-plus"></i> Add Video Gallery</a></td>
 ...
 -->
            ...
            if(count($vedio_gallery_list )>0)
            {
                ...
                <tr>
                  ...
                  <td>
                     <a href="<?php echo base_url();?>index.php/manage_video_category/video_gallery_edit/<?php echo $row->video_gallery_id;?>" class="btn btn-success" title="View"><i class="fa fa-pencil"></i></a>
...
function delete_data(id)
  { 
    ...
    {
      window.location = base_url+'index.php/manage_video_category/delete_data/'+id;
    } 
  } 
       ...
       function change_sts_active(val)
        {
          //alert(val);
            ...
            if(pro_ids.length>0)
            {
              ...
              url:base_url+'index.php/manage_video_category/change_to_active_video_gallery',
