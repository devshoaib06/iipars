<?php return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/var/www/html/iipars/ugc-net/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/app/public',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/banner',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/materials',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/courses',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/mentors',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/articles/images',
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/html/iipars/ugc-net/storage/uploads/articles/files',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/var/www/html/iipars/ugc-net/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/var/www/html/iipars/ugc-net/resources/views/vendor/mail',
      ),
    ),
    'log_channel' => NULL,
  ),
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/var/www/html/iipars/ugc-net/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'paths' => 
    array (
      0 => '/var/www/html/iipars/ugc-net/resources/views',
    ),
    'compiled' => '/var/www/html/iipars/ugc-net/storage/framework/views',
  ),
  'dompdf' => 
  array (
    'show_warnings' => false,
    ...
    'defines' => 
    array (
      'font_dir' => '/var/www/html/iipars/ugc-net/storage/fonts/',
      'font_cache' => '/var/www/html/iipars/ugc-net/storage/fonts/',
      'temp_dir' => '/tmp',
      'chroot' => '/var/www/html/iipars/ugc-net',
