    ...
    function _CreateMessageBox(instance) {
        ...
        if (settings.buttonDone) {
            ...
            if (typeof settings.buttonDone === "string") {
                buttons = buttons.add(_CreateButton("messagebox_button_done btn btn-warning", _constants.buttonDoneName, {
        ...
        if (settings.buttonFail) {
            ...
            if (typeof settings.buttonFail === "string") {
                buttons = buttons.add(_CreateButton("messagebox_button_fail btn btn-default", _constants.buttonFailName, {
