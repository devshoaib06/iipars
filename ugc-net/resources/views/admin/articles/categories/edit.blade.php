                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="{{route('editArticleCategoryAction',['id'=>Hasher::encode($article_info->id)])}}" id="form_sample_1" class="form-horizontal" method="POST">
                                    {!! csrf_field() !!}
                                    <div class="form-body">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            ...
                                            <a href="{{route('showcategoryList')}}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
