                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject  sbold ">Edit Coupon</span>
                                </div>
                                <!--<div class="actions">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('couponUpdate',['id'=> Hasher::encode($coupon->coupon_id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="coupon_name" class="form-control"  value="{{ $coupon->coupon_name }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select name="discount_type" id="discount_type" class="form-control">
                                                    ...
                                                    <option value="2" @if($coupon->discount_type=="2") Selected @endif>Percent</option> 
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="price" class="form-control"  value="{{ $coupon->price }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="coupon_code" class="form-control" value="{{ $coupon->coupon_code }}" autocomplete="off" /> </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="uses_per_student" class="form-control" value="{{ $coupon->uses_per_student }}" autocomplete="off" /> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control date-picker" name="start_date" size="16" type="text" value="{{\Carbon\Carbon::parse($coupon->start_date)->format('m/d/Y')}}" />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control date-picker" name="end_date" size="16" type="text" value="{{\Carbon\Carbon::parse($coupon->end_date)->format('m/d/Y')}}" />
                                            </div>
