                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-dark sbold uppercase"> Edit Combo Course - {{$product->name}}
                                    </span>
                                </div>
                            ...
                            <div class="portlet-body">
							     ...
							     <form role="form" action="{{route('editComboCourseAction',['id'=>\Hasher::encode($product->combo_id)])}}" id="course_info_form" method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }} 
                                                    ...
                                                    <div class="tab-content">
                                                        <div id="tab_1-1" class="tab-pane active">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control  date-picker" name="expiry_date" size="16" type="text" value="{{\Carbon\Carbon::parse($product->expiry_date)->format('m/d/Y')}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                                        ...
                                                                                        <img src="{{asset(config('path.course_image')).'/'.$product->image}}" alt="" ddff /> </div>
																...
																<div class="form-group">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="example-inline-radio1">
                                                                            <input id="example-inline-radio1" type="radio" value="1" name="is_popular" {{$product->is_popular==1?'checked':''}}> Yes</label>
                                                                        <label class="radio-inline" for="example-inline-radio2">
                                                                            <input id="example-inline-radio2" type="radio" value="0" name="is_popular" {{$product->is_popular==0?'checked':''}}> No</label>
                                                                    </div>
                                                                </div> 
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="example-inline-radio5">
                                                                            <input id="example-inline-radio5" type="radio" value="1" name="home_slider" {{$product->home_slider==1?'checked':''}} > Yes</label>
                                                                        <label class="radio-inline" for="example-inline-radio6">
                                                                            <input id="example-inline-radio6" type="radio" value="0" name="home_slider" {{$product->home_slider==0?'checked':''}} > No</label>
                                                                    </div>
                                                                </div> 
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="example-inline-radio3">
                                                                            <input id="example-inline-radio3" type="radio" value="1" name="status" {{$product->status==1?'checked':''}}> Active</label>
                                                                        <label class="radio-inline" for="example-inline-radio4">
                                                                            <input id="example-inline-radio4" type="radio" value="0" name="status" {{$product->status==0?'checked':''}}> Inactive</label>
                                                                    </div>
                                                                </div> 
                                        ...
                                        <div class="tab-pane" id="tab_2">
                                            ...
                                            @endphp
                                                ...
                                                @php 
                                                    ...
                                                    $product_relates=$myFunction->checkRelatedProduct($key,$product->combo_id);
                                                @endphp
                                            <div class="form-group">
                                                    <div class="product-cont">
                                                        <input type="checkbox" class="product-check" name="products[]" value="{{$key}}" {{$product_relates?'checked':''}} ><label> {{$myFunction->getProductName($key)}}</label>
                                                        <ul class="contri-list" style="{{!$product_relates?'display: none;':''}}">
                                                           @foreach($item as $contributor)
                                                            @php 
                                                                $contributor_relates=$myFunction->checkRelatedContributor($key,$contributor->contributor_id,$product->combo_id);
                                                            @endphp
                                                            <li class="product-item" {{$product->combo_id}} {{$contributor->contributor_id}}>
                                                                <input type="checkbox" class="conti-check" name="contributors[]" value="{{$contributor->contributor_id}}" {{$contributor_relates?'checked':''}}>   {{$contributor->firstname .' '.$contributor->lastname }}
                                                                <span class="prod_contributors_span" style="display: none;">
                                                                <input type="checkbox" class="prod_contributors" name="prod_contributors[]" value="{{$contributor->product_id}}" {{$contributor_relates?'checked':''}} >
                                                                 </span>
                                                            </li>
                                                             @endforeach
                                            ...
                                            <div class="row">
                                                ...
                                                $video_embed_link=$myFunction->parseYouTubeUrl($video->video_url);?>
                                                    <div class="col-sm-3 pb-30 video">
                                                        {{-- <iframe width="auto" height="auto"  src="{{$video->video_url}}"> --}}
...
<script type="text/javascript">	
     ...
     $(document).ready(function(){
        ...
        $(".product-check").on('click',function(){
            ...
            $(this).parents(".product-cont").find('.prod_contributors').prop('disabled',true);
            if($(this).is(':checked')){

                $(this).parents(".product-cont").find("ul").show();
                $(this).parents(".product-cont").find("li.product-item").find('input.conti-check').click();
                $(this).parents(".product-cont").find("ul").find('.conti-check').prop('disabled',false);
                $(this).parents(".product-cont").find('.prod_contributors').prop('disabled',false);
            }
        })
