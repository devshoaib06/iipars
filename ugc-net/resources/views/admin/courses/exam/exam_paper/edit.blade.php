                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('examPaperUpdate',['id'=> Hasher::encode($relatedexam->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="exam" id="exam" class="form-control">
                                                        ...
                                                        <option value="{{$exam['id']}}" {{$exam['id']==$relatedexam->exam_id?'selected':''}} >{{$exam['exam_name']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="paper" id="paper" class="form-control">
                                                        ...
                                                        <option value="{{$paper['id']}}" {{$paper['id']==$relatedexam->paper_id?'selected':''}} >{{$paper['paper_name']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 material-list">
                                                    @foreach ($allMaterials as $material)
                                                     ...
                                                     <input id="material-inline-checkbox{{$material->id}}" type="checkbox" value="{{$material->id}}" name="material_list[]" 
                                                        {{in_array($material->id,$related_materials)?'checked':''}}
                                                     > 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio-list col-md-6">
                                                    <label class="radio-inline" for="example-inline-radio1">
                                                        <input id="example-inline-radio1" type="radio" value="1" name="status" {{$relatedexam->status?'checked':''}}> Active</label>
                                                    <label class="radio-inline" for="example-inline-radio2">
                                                        <input id="example-inline-radio2" type="radio" value="0" name="status" {{$relatedexam->status?'':'checked'}}> Inactive</label>
                                                </div>
                                            </div>
