                                                        ...
                                                        <div id="tab_1-1" class="tab-pane active">
                                                            ...
                                                            <div class="form-group " id="paper-section">
                                                                ...
                                                                <div class="check-list">
                                                                    <div class="subject-section paper-list">
                                                                        <div class="form-group">
                                                                            <label class="control-label subject-info">Unit <span class="required"> * </span></label>
                                                                            <div class="radio-list subject-list">
                                                                                <label class="check " for="subject-check-all-{{ @$allSubjects[0]->id }}">
                                                                                    <input id="subject-check-all-{{ @$allSubjects[0]->id }}" class="subject-list-all-check" type="checkbox" value="1" name="all_subject{{ @$allSubjects[0]->id }}[]">All
                                                                                </label>    
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="intro_text" id="intro_text" class="form-control">{{$product->intro_text}}</textarea> 
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control  date-picker" name="start_date" size="16" type="text" value="{{\Carbon\Carbon::parse($product->start_date)->format('d/m/Y')}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control  date-picker" name="end_date" size="16" type="text" value="{{\Carbon\Carbon::parse($product->end_date)->format('d/m/Y')}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="meta_title" size="16" type="text" value="{{ $product->meta_title}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="meta_robots" size="16" type="text" value="{{ $product->meta_robots}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" name="meta_description" rows="10">{{ $product->meta_description }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="slug" size="16" type="text" value="{{ $product->slug}}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="img_alt" size="16" type="text" value="{{ $product->img_alt}}" />
                                                                ...
                                                                <div class="form-group hide">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="combo-course-inline-radio1">
                                                                            <input id="combo-course-inline-radio1" type="radio" value="1" name="is_combo" {{$product->is_combo==1?'checked':''}} > Yes</label>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="preview-inline-radio1">
                                                                            <input id="preview-inline-radio1" type="radio" value="1" name="is_preview" {{$product->is_preview==1?'checked':''}} > Yes</label>
                                                                ...
                                                                <div class="form-group hide">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="reseller-inline-radio5">
                                                                            <input id="reseller-inline-radio5" type="radio" value="1" name="is_reseller_charge" {{$product->is_reseller_charge==1?'checked':''}} > Yes</label>
                                                                        <label class="radio-inline" for="reseller-inline-radio6">
                                                                            <input id="reseller-inline-radio6" type="radio" value="0" name="is_reseller_charge" {{$product->is_reseller_charge==0?'checked':''}}> No</label>
                                                                    </div>
                                                                </div> 
                                                                <div class="form-group">
...
<script type="text/javascript">
    CKEDITOR.replace( 'pdesc', {
        ...
        $(document).on('click','.subject-list-all-check',function(){
            //debugger;
            $(this).parents('.paper-list').find('.subject-list-check').prop('checked',false);
            $(this).parents('.paper-list').find('.checker').find('span').removeClass('checked');
            if($(this).is(":checked")){
                $(this).parents('.paper-list').find('.checker').find('span').addClass('checked');
                $(this).parents('.paper-list').find('.subject-list-check').prop('checked',true);
            }
