...
<link href="{{config('path.assets_path')}}/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css"
    rel="stylesheet" type="text/css" />
<link href="{{config('path.assets_path')}}/assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css"
    rel="stylesheet" type="text/css" />
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('subjectUpdate',['id'=> Hasher::encode($subject->id) ]) }}"
                                        ...
                                        <div class="col-md-6">
                                            <select name="exam_id" id="exam_id" class="form-control">
                                                ...
                                                <option value="{{$exam['id']}}"
                                                    {{($subject->exam_id==$exam['id'])?"selected":""}}>
                                            ...
                                            <select name="paper_id" id="paper_id" class="form-control">
                                                ...
                                                @foreach($allPapers as $paper)   
                                                    <option value="{{$paper->paper_id}}"
                                                        {{($paper->paper_id==$subject->paper_id)?"selected":""}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="subject_name" class="form-control"
                                                value="{{ $subject->subject_name }}"/ autocomplete="off"> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="subject_slug" class="form-control"
                                                value="{{ $subject->subject_slug }}"/ autocomplete="off" > </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{ route('subjects') }}"><button type="button"
...
<script src="{{config('path.assets_path')}}/assets/global/plugins/jquery-validation/js/additional-methods.min.js"
    type="text/javascript"></script>
<script src="{{config('path.assets_path')}}/assets/global/plugins/select2/js/select2.full.min.js"
    type="text/javascript"></script>
<script src="{{config('path.assets_path')}}/assets/global/plugins/backstretch/jquery.backstretch.min.js"
    type="text/javascript"></script>
...
<script src="{{config('path.assets_path')}}/assets/pages/scripts/components-date-time-pickers.min.js"
    type="text/javascript"></script>
@endsection
