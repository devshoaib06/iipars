        ...
        <div class="form-group cloneans clonerow"  >
            ...
            <div class="col-md-1">
                <input type="text" name="ans_serial_no{{$k}}" class="form-control" {{$k<3?'required':''}}  value="{{$questionAnswer->serial_no}}"/> 
                    {{-- <textarea name="ans_serial_no{{$k}}" rows="8" class="form-control ceditor" id="ans_serial_no{{$k}}" >{{$questionAnswer->serial_no}}</textarea> --}}
                    
                </div>
            <div class="col-md-5">
            {{-- <input type="text" name="answer{{$k}}"  class="form-control" {{$k<3?'required':''}} id="answer{{$k}}" value="{{$questionAnswer->answer}}"/>  --}}
    ...
    @for ($i = 1; $i <5; $i++)
        <div class="form-group cloneans" >
            ...
            <div class="col-md-1">
                ...
                {{-- <textarea name="ans_serial_no{{$i}}" rows="8" class="form-control ceditor" id="ans_serial_no{{$i}}" >{{old('ans_serial_no'.$i)}}</textarea> --}}
