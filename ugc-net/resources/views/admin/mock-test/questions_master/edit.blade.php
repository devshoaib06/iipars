                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="question" rows="8" class="form-control" id="question" >{{$question->question}}</textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="correct_explanation" rows="8" class="form-control" id="correct_explanation" >{{$question->correct_explanation}}</textarea>
                                            </div>
...
{{-- <script src="public/assets/global/plugins/ckeditor4.14/plugins/ckeditor_wiris/plugin.js" type="text/javascript"></script> --}}

{{-- <link rel="stylesheet" href="public/assets/global/plugins/ckeditor/plugins/chart/chart.css">
<script src="public/assets/global/plugins/ckeditor/plugins/chart/lib/chart.min.js"></script>
<script src="public/assets/global/plugins/ckeditor/plugins/chart/widget2chart.js"></script> --}}
@endsection
