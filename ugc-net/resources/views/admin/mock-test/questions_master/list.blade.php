                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="employer_list">
                                        <thead>
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td>
                                                    {{-- <select name="level_id" class="form-control form-filter input-sm">
                                                    ...
                                                    {{-- <select name="option_type" class="form-control form-filter input-sm">
                                                        <option value="">Select...</option>
                                                        @foreach ($option_types as $key=>$option_type)
...
<script type="text/javascript">
        ...
        var question_id=$(this).data('value');
            ...
            var url="{{route('ajaxQuestionDelete')}}";
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "{{ url(route('ajaxMockQuestionList')) }}", // ajax source					
                        },
