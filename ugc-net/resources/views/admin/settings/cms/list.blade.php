                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ url(config("constants.admin_prefix").'/cms/add') }}"><button id="sample_editable_1_new" class="btn sbold green"> Add New
                                    ...
                                    <tbody>
                                        ...
                                        if(!empty($CmsMasters))
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td> {{ App\library\myFunctions::dateText($v->updated_at,'d_m_y') }} </td>
                                                <td>
                                                    @if ($v->status == '1')
                                                ...
                                                <td>  
                                                 ...
                                                 <a  href="{{ url(config("constants.admin_prefix").'/cms/edit') }}/{{\Hasher::encode($v->cms_id)}}" data-toggle="tooltip" class="btn btn-default btn-sm"><i class="fa fa-edit "></i>Edit</a>
