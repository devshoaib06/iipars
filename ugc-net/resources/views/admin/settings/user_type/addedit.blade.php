                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">@if (isset($user_type)){{
                        "Edit Work User Type"
                                            }} @else
                                            {{"Add New User Type"}}
                                            @endif</span>
                                ...
                                <form action="{{$form_url}}" id="form_sample_1" class="form-horizontal" method="POST">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">User type name
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-4"><input type="text" name="name" class="form-control" value="@if (isset($user_type->name)){{$user_type->name}}@endif" /> </div>
                                        </div>
                                            ...
                                            <div class="radio-list">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="status"
                                                           <?php if(!empty($user_type) && $user_type->status == '1')  echo "checked";?> <?php if(empty($user_type)) echo "checked"; ?>
                                                           >Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="status" 
                                                           @if (isset($user_type->status))
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="{{ url(config("constants.admin_prefix").'/user-type') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
