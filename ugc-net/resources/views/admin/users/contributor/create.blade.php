			...
			<div class="page-content">
				...
				<div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('createContributor')}}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- BEGIN FORM-->
                                    ...
                                    <div class="form-body">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="anothercontactnumber" class="form-control" value="{{ old('anothercontactnumber') }}" id="anothercontactnumber"/> </div>
                                            @if ($errors->has('anothercontactnumber'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('anothercontactnumber') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="form-group display-hide">
                                            ...
                                            <div class="col-md-6">
                                                <select name="country" id="country" class="form-control">
                                                    ...
                                                    <option value="{{$counties['id']}}" {{$counties['id']=='100'?'selected':''}}>{{$counties['country_name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox-list col-md-6 subject-list">
                                               @foreach ($allSubjects as $subject)
                                                ...
                                                <input id="example-inline-checkbox{{$subject->id}}" type="checkbox" value="{{$subject->id}}" name="subject_list[]"> {{$subject->subject_name}}</label>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{ route('contributors') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
