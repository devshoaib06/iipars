                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-user "></i>
                                    <span class="caption-subject  sbold ">Edit Mentor - {{$user_info->name}}
                                    </span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="{{route('mentor-update',['id'=>\Hasher::encode($user_info->id)])}}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="name" class="form-control"  value="{{$user_info->name}}"/> </div>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="qualification" class="form-control" value="{{$user_info->qualification}}" id="qualification"/> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
												<img src="{{Storage::disk(config('disk.get_mentor'))->url($user_info->image)}}" width="100px" height="100px">
											</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="featured-inline-radio1">
                                                    <input id="featured-inline-radio1" type="radio" value="1" name="is_featured" {{$user_info->is_featured==1?'checked':''}}> Yes</label>
                                                <label class="radio-inline" for="featured-inline-radio2">
                                                    <input id="featured-inline-radio2" type="radio" value="0" name="is_featured" {{$user_info->is_featured==0?'checked':''}}> No</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="status" {{$user_info->status==1?'checked':''}}> Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="status" {{$user_info->status==0?'checked':''}}> Inactive</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                    </div>
