                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    ...
                                    <a href="{{route('students')}}" class="btn default">Back</a>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="tab-content">
                                                        <div id="tab_1-1" class="tab-pane active">
                                                            <form action="{{route('student-update',['id'=>Hasher::encode($user_info->id)])}}" id="user_info_form"  method="POST">
                                                        ...
                                                        <div id="tab_3-3" class="tab-pane">
                                                            ...
                                                            <form action="{{route('student-password-update',['id'=>Hasher::encode($user_info->id)])}}" id="password_checking"  method="POST">
                                                                {!! csrf_field() !!}
                                                                <div class="form-group">
