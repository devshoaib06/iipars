                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('videoUpdate',['id'=> Hasher::encode($video->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" name="title" class="form-control" value="@if (isset($video->title)){{$video->title}}@endif" autocomplete="off"/> </div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" name="video_url" class="form-control" value="@if (isset($video->video_url)){{$video->video_url}}@endif" autocomplete="off"/> </div>
											</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="{{ route('videos') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
										</div>
									</div>
                                </div>
													</form>
