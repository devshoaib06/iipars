      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-9">
                <h1>Edit Account</h1>
                <form class="form-horizontal" action="{{route('contributor-account-update',['id'=>Hasher::encode(@$userinfo->id)])}}" method="post" id="myaccount-form">
                    {!! csrf_field() !!}
                    ...
                    <div class="personalInfo">
                        ...
                        @foreach ($allSubjects as $allSubject)
                            <label class="checkbox-inline">
                                <input type="checkbox" value="{{$allSubject->id}}" name="subjects[]"
                                    {{in_array($allSubject->id,$relatedsubject)?'checked':''}}
                                >
                                {{$allSubject->subject_name}}
                            </label>
