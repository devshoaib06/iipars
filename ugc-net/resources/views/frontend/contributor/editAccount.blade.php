      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="tabCont">
                    <h1>Edit Account</h1>
                    <form action="{{route('contributor-account-update',['id'=>Hasher::encode(@$userinfo->id)])}}" method="post" id="myaccount-form">
                        {!! csrf_field() !!}
                        ...
                        <div class="personalInfo">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="qualification" placeholder="" value="{{$userinfo->qualification}}">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            @foreach ($allSubjects as $allSubject)
                                <li>
                                    <label><input type="checkbox" value="{{$allSubject->id}}" name="subjects[]"
                                        {{in_array($allSubject->id,$relatedsubject)?'checked':''}}
                                    >
                                    {{$allSubject->subject_name}}</label>
                                </li>    
                            @endforeach 
                            </ul>   
                            </div>
