                                ...
                                <div class="panel-heading" role="tab" id="heading-{{$course->tech_order_id}}">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion"
                                            href="#collapse-{{$course->tech_order_id}}" aria-expanded="true"
                                            aria-controls="collapse-{{$course->tech_order_id}}">
                                            <i class="more-less glyphicon glyphicon-plus"></i>
                                            {{$course->product_name}}
                                            <span class="text-primary">Enrollment expires on :
                                                {{\Carbon\Carbon::parse($course->end_date)->format('d/m/Y')}} </span>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapse-{{$course->tech_order_id}}"
                                    class="panel-collapse collapse {{$count==1?'in':''}}" role="tabpanel"
                                    aria-labelledby="heading-{{$course->tech_order_id}}">
                                                    ...
                                                    <div class="content_exists">
                                                        <div class="row">
                                                            <div class="col-sm-7">
                                                                ...
                                                                <a
                                                                    href="{{route('downloadContent',['media_id'=>$cdata->media_id])}}">{{$cdata->value}}</a>
                                                            </div>
                                                            <div class="col-sm-5 text-right">
                                                                <span class="downloadbut">
                                                                    <a
                                                                        href="{{route('downloadContent',['media_id'=>$cdata->media_id])}}"><i
                                                                            class="fa fa-file"></i> Download</a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="video-section">
                                                        ...
                                                        <div class="video-container">
                                                            <iframe width="100%" height="300px"
                                                                src="{{$protocol}}://www.youtube.com/embed/{{$video_embed_link}}"
                                                                frameborder="0"
                                            ...
                                            <div class="pdf-section stest">
                                                <div class="content_exists">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5 text-right">
                                                            <span class="downloadbut">
                                                                <a href="{{route('studentMocktest',['course_id'=>Hasher::encode($course->product_id)])}}"
                                                                    style="
                                                                                    width: 20%;
                                                                                    text-align: center;
