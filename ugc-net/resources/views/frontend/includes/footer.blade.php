			...
			<div class="col-sm-6 col-md-3">
				...
				<div class="widget">
					...
					<ul class="list-border">
						...
						<li><a href="{{ config('path.iipars_base_url') }}/cms/page/privacy_policy">Privacy Policy</a></li>

						<li><a href="{{ config('path.iipars_base_url') }}/cms/page/terms-conditions">Terms & Conditions</a></li>
			...
			<div class="col-sm-6 col-md-3">
				...
				<div class="widget">
					...
					<ul class="list-border">
						...
						<li><a href="{{ config('path.iipars_base_url') }}/cms/page/upcoming_courses">Upcoming Courses</a></li>
