            ...
            <div id="newsTicker" class="accounceBox ticker">
                <ul>
                    @foreach ($newsfeed as $news)
                        @if ($news->image == '')
                            <li><a download href="{{ $news->description }}" target="_blank">{{ $news->title }}<img
                                        src="{{ config('path.iipars_base_url') }}assets/img/new.gif"
                                        class="new_gif_class"></a>
                            </li>

                        @else
                            <li><a download
                                    href=" {{ config('path.iipars_base_url') }}/upload/news_feed/{{ $news->image }}"
                                    target="_blank">{{ $news->title }}<img
                                        src="{{ config('path.iipars_base_url') }}assets/img/new.gif"
                                        class="new_gif_class"></a>
                            </li>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3">
                <a class="menuzord-brand pull-left flip sm-pull-center"
                    href="{{ config('path.iipars_base_url') }}/"><img
            ...
            <div class="col-xs-12 col-sm-4 col-md-9 text-ali-rt text-ce-res">
                ...
                <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1"  style="margin-top:-1px">
                        ...
                        <li><a href="{{route('frontendlogout')}}"><i
                ...
                @guest
                <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
                  {{-- <a class="btn mt-10 btn-success" class="login" data-toggle="modal" data-target=".login-modal"><i
                          class="fa fa-sign-in" aria-hidden="true"></i> <strong>Login</strong>
                  </a> --}}
                  <a class="btn mt-10 btn-success" class="login" href="{{ url('/log-in') }}"><i
                          class="fa fa-sign-in" aria-hidden="true"></i> <strong>Login</strong>
                  </a>
                </div>
                @endguest
