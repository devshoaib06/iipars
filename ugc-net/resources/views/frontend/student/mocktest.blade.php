        ...
        <section class="innerpage">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="tabCont">
                            <h1>{{ $exam }} <span class="text-secondary">Enrollment expires on :
                                    {{ \Carbon\Carbon::parse($course->end_date)->format('d/m/Y') }} </span></h1>
                            ...
                            <div class="panel-group dashboard" id="accordion" role="tablist" aria-multiselectable="true">
                                @if (count($pending_tests) > 0)
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse-" class="panel-collapse collapse {{ $count == 1 ? 'in' : '' }}"
                                                        ...
                                                        <div class="pdf-section">
                                                            ...
                                                            <div class="content_exists">
                                                                ...
                                                                <div class="col-sm-2 text-right">
                                                                    <form
                                                                        action="{{ route('startPaidExam', ['mock_test_id' => \Hasher::encode($pending_test->id)]) }}"
                                                                        method="POST">
                                                                        @csrf
                                    ...
                                    @foreach ($content_info as $cinfo)
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-heading" role="tab" id="heading-">
                                                <h4 class="panel-title">
                                                    <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapse-{{ $cinfo['paper_id'] }}" aria-expanded="true"
                                                        aria-controls="collapse-{{ $cinfo['paper_id'] }}">
                                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                            ...
                                            <div id="collapse-{{ $cinfo['paper_id'] }}"
                                                class="panel-collapse collapse {{ $count == 1 ? 'in' : '' }}" role="tabpanel"
                                                aria-labelledby="heading-{{ $cinfo['paper_id'] }}">
                                                <div class="panel-body">
