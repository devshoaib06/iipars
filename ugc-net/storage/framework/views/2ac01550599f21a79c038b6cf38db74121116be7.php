			...
			<div class="page-content">
				...
				<div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(route('createDistributor')); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Commission
                                                ...
                                                <input type="text" name="commission" id="commission" class="form-control" value="<?php echo e(old('commission')); ?>"/>
												</div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="<?php echo e(route('distributors')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/users/distributor/create.blade.php ENDPATH**/ ?>