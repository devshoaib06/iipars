                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject  sbold ">Edit Testimonial</span>
                                </div>
                                <!--<div class="actions">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="<?php echo e(route('testimonialUpdate',['id'=> Hasher::encode($testimonial->id) ])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										...
										<div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="student_name" class="form-control"  value="<?php echo e($testimonial->student_name); ?>"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="student_course" class="form-control" value="<?php echo e($testimonial->student_course); ?>" autocomplete="off" /> </div>
                                            ...
                                            <select class="form-control" name="testimonial_type" id="testimonial_type">
                                                    ...
                                                    <option value="1" <?php if( $testimonial->testimonial_type == 1 ): ?> selected <?php endif; ?>>Video</option>
                                                    <option value="2" <?php if( $testimonial->testimonial_type == 2 ): ?> selected <?php endif; ?>>Text</option>
                                                </select>
                                        ...
                                        <div class="form-group" <?php if( $testimonial->testimonial_type == 1): ?> style="display:block;" <?php else: ?>  style="display:none;"  <?php endif; ?> id="video_block">
                                            <label class="control-label col-md-3">Video URL
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="video_url"  id="video_url" class="form-control" value="<?php echo e($testimonial->video_url); ?>" autocomplete="off" /> </div>

                                        </div> <!--Last Name-->

                                        <div class="form-group"  <?php if( $testimonial->testimonial_type == 2): ?> style="display:block;" <?php else: ?>  style="display:none;" <?php endif; ?> id="testimonial_block">
                                            <label class="control-label col-md-3">Testimonial Content
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6"> 
                                                <textarea name="testimonial_text" id="pdesc" rows="20" cols="50" class="form-control" /><?php echo e($testimonial->testimonial_text); ?></textarea>
												...
												<div class="radio-list col-md-6"> 
													<label class="radio-inline" for="example-inline-radio3">
														<input id="example-inline-radio3" type="radio" value="1" name="status"
																<?php if(isset($testimonial->status)): ?>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo e(route('testimonials')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
										</div>
									</div>
                                </div>
													</form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/iipars/ugcnet/resources/views/admin/testimonial/edit.blade.php ENDPATH**/ ?>