            ...
            <div id="newsTicker" class="accounceBox ticker">
                <ul>
                    <?php $__currentLoopData = $newsfeed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($news->image == ''): ?>
                            <li><a download href="<?php echo e($news->description); ?>" target="_blank"><?php echo e($news->title); ?><img
                                        src="<?php echo e(config('path.iipars_base_url')); ?>assets/img/new.gif"
                                        class="new_gif_class"></a>
                            </li>

                        <?php else: ?>
                            <li><a download
                                    href=" <?php echo e(config('path.iipars_base_url')); ?>/upload/news_feed/<?php echo e($news->image); ?>"
                                    target="_blank"><?php echo e($news->title); ?><img
                                        src="<?php echo e(config('path.iipars_base_url')); ?>assets/img/new.gif"
                                        class="new_gif_class"></a>
                            </li>
    ...
    <div class="container pt-20 pb-20 p_cus_mobile_all_header_ppp">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3">
                <a class="menuzord-brand pull-left flip sm-pull-center"
                    href="<?php echo e(config('path.iipars_base_url')); ?>/"><img
            ...
            <div class="col-xs-12 col-sm-4 col-md-9 text-ali-rt text-ce-res">
                ...
                <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
                    <div class="dropdown">
                      <button class="btn mt-10 btn-success dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        Hi <?php echo e(Auth::user()->name); ?>

                        <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1"  style="margin-top:-1px">
                        <li><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
                        <!-- <li role="separator" class="divider"></li> -->
                        <li><a href="<?php echo e(route('frontendlogout')); ?>"><i
                            class="fa fa-sign-in" aria-hidden="true"></i> <strong>Log Out</strong></a></li>
                      </ul>
                    </div>
                ...
                <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
                  ...
                  <a class="btn mt-10 btn-success" class="login" href="<?php echo e(url('/log-in')); ?>"><i
                          class="fa fa-sign-in" aria-hidden="true"></i> <strong>Login</strong>
                  </a>
                </div>
                <?php endif; ?>
...
<?php /**PATH /var/www/html/iipars/ugc-net/resources/views/frontend/includes/top_header_bar.blade.php ENDPATH**/ ?>