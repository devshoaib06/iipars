...
<link href="<?php echo e(config('path.assets_path')); ?>/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="question" rows="8" class="form-control" id="quest" ><?php echo e(old('question')); ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="option_type_1">
                                                    <input id="option_type_1" type="radio" value="0" name="option_type" checked > None</label>
                                                <label class="radio-inline" for="option_type_2">
                                                    <input id="option_type_2" type="radio" value="1" name="option_type" > Simple</label>
                                                <label class="radio-inline" for="option_type_3">
                                                    <input id="option_type_3" type="radio" value="2" name="option_type" > Conjugate</label>    
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="is_active" checked > Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="is_active" > Inactive</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                    </div>
...
<script src="<?php echo e(config('path.assets_path')); ?>/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/questions_master/create.blade.php ENDPATH**/ ?>