                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo e(route('editQuestionAction',['id'=>\Hasher::encode($question->id)])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea name="question" rows="8" class="form-control" ><?php echo e($question->question); ?></textarea>
                                            </div>
                                        ...
                                        <?php for($i = 0; $i < 4; $i++): ?>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Option #<?php echo e($i+1); ?>

                                                </label>
                                                <div class="col-md-6">
                                                <input type="text" name="options<?php echo e($i+1); ?>" class="form-control"  value="<?php echo e(@$related_answers[$i]->answer); ?>"/> 
                                            ...
                                            <div class="col-md-6">
                                                <select name="correct" id="correct" class="form-control">
                                                    ...
                                                    <?php 
                                                        $j=1;
                                                    ?>
                                                    <?php $__currentLoopData = $related_answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="options<?php echo e($j); ?>" <?php echo e($option->is_correct==1?'selected':''); ?> ><?php echo e($option->answer); ?></option>
                                                      <?php 
                                                        $j++;
                                                      ?>  
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="correct_clarification" rows="8" class="form-control" ><?php echo e($question->correct_clarification); ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="status" <?php echo e($question->status==1?'checked':''); ?> > Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="status" <?php echo e($question->status==0?'checked':''); ?>> Inactive</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/questions/edit.blade.php ENDPATH**/ ?>