                                                            ...
                                                            <div class="form-group " id="paper-section">
                                                                ...
                                                                <div class="check-list">
                                                                    ...
                                                                    <?php $__currentLoopData = $allPapers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paper): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <label class="check-inline" for="example-radio<?php echo e($paper->paper_id); ?>">
                                                                            <input id="example-radio<?php echo e($paper->paper_id); ?>" 
                                                                                   type="checkbox" 
                                                                                   value="<?php echo e($paper->paper_id); ?>" 
                                                                                   name="paper_list[]"
                                                                                   class="paper_check"
                                                                                   <?php echo e(in_array($paper->paper_id,$relatedPapers)?'checked':''); ?>
                                                                                ...
                                                                                <div class="material-section">
                                                                                    ...
                                                                                    <div class="check-list paper-material-list">
                                                                                        ...
                                                                                        <label class="check col-sm-12" >
                                                                                            ...
                                                                                            type="checkbox" 
                                                                                            value="1" 
                                                                                            name="all_material<?php echo e($paper->paper_id); ?>[]"
                                                                                            <?php echo e(@in_array('1',$all_material_array[$paper->paper_id])?'checked':''); ?>
                                                                                        ...
                                                                                        <?php if($paper->paper_id==$material['paper_id']): ?>
                                                                                            ...
                                                                                            <label class="check col-sm-12" >
                                                                                                ...
                                                                                                name="material_list<?php echo e($paper->paper_id); ?>[]"
                                                                                                <?php echo e(@in_array($material['material_id'],$selectedmaterials[$paper->paper_id])?'checked':''); ?>
                                                                                ...
                                                                                <div class="subject-section">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="radio-list subject-list">
                                                                                            ...
                                                                                            <label class="radio-inline" for="example-inline-radio<?php echo e($paper->paper_id); ?>-<?php echo e($subject->id); ?>">
                                                                                                <input id="example-inline-radio<?php echo e($paper->paper_id); ?>-<?php echo e($subject->id); ?>" 
                                                                                                type="checkbox" 
                                                                                                value="<?php echo e($subject->id); ?>" 
                                                                                                name="subject_list<?php echo e($paper->paper_id); ?>[]"
                                                                                                <?php echo e(@in_array($subject->id,$relatedSubjects[$paper->paper_id])?'checked':''); ?>
																...
																<div class="form-group">
                                                                    ...
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline" for="featured-inline-radio1">
                                                                            <input id="featured-inline-radio1" type="radio" value="1" name="is_popular" <?php echo e($product->is_popular==1?'checked':''); ?>> Yes</label>
                                                                        <label class="radio-inline" for="featured-inline-radio2">
                                                                            <input id="featured-inline-radio2" type="radio" value="0" name="is_popular" <?php echo e($product->is_popular==0?'checked':''); ?>> No</label>
                                                                    </div>
                                                                </div> 
                                                                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/products/edit.blade.php ENDPATH**/ ?>