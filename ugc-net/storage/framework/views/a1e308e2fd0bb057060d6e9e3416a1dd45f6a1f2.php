                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td>
                                                    <select name="user_id" id="user_id" class="form-control form-filter input-sm" > 
                                                        ...
                                                        <?php $__currentLoopData = $allStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($v->id); ?>" ><?php echo e($v->firstname); ?> <?php echo e($v->lastname); ?></option>
                                                ...
                                                <td>
                                                    <select name="product_id" id="product_id" class="form-control form-filter input-sm" > 
                                                        ...
                                                        <?php $__currentLoopData = $allCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->product_id); ?>" ><?php echo e($v->name); ?>  </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </td>
...
<script>
    $('body').on('click','.remove-order',function(){
        ...
        var order_id=$(this).data('value');
            ...
            var url="<?php echo e(route('ajaxOrderDelete')); ?>";
    ...
    $(document).on('click','.viewBilling',function(){
       // 
        let url="<?php echo e(route('viewOrderDetails')); ?>";
        let data={
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/orders/list.blade.php ENDPATH**/ ?>