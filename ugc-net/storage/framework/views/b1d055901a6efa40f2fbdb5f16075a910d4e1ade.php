                    ...
                    <div class="tabCont">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="order_table">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $allmocktests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mocktest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                        $status="";
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo e($mocktest->test_name); ?></td>
                                        <td><?php echo e($mocktest->subject->subject_name); ?></td>
                                        <td><?php echo e($mocktest->course->name); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($mocktest->start_datetime)->format('d/m/Y')); ?></td>
                                        <td><?php echo e($mocktest->secured_marks); ?></td>
                                        <td><?php echo e($mocktest->full_marks); ?></td>
                                        <?php if($mocktest->countdown>0): ?>
                                            <td> <span class="label label-sm label-warning">Pending</span>
                                                <a href="<?php echo e(route('mocktest',['mock_test_id'=>\Hasher::encode($mocktest->id)])); ?>">
...
<script src="<?php echo e(asset('public/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js')); ?>" type="text/javascript"></script>
<script type="text/javascript">
        ...
        var handleHistory = function () {
            ...
            grid.init({
                ...
                dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "bProcessing": true,
                    "ajax": {                            
                        "url": "<?php echo e(url(route('ajaxOrderList'))); ?>", // ajax source					
                    },
    ...
    jQuery(document).ready(function () {
        ...
        let url="<?php echo e(route('viewOrderInfo')); ?>";
        let data={
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.layout_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/frontend/paid-mock-test/student/_mocktest.blade.php ENDPATH**/ ?>