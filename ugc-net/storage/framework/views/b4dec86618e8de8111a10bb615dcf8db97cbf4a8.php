                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject  sbold ">Edit Paper</span>
                                </div>
                                <!--<div class="actions">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="<?php echo e(route('paperUpdate',['id'=> Hasher::encode($paper->id) ])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
                                                ...
                                                <select name="exam_id" id="exam_id" class="form-control"> 
                                                   <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?php echo e($exam['id']); ?>" <?php if(isset($paper->exam_id) && $paper->exam_id==$exam['id']): ?> selected="selected" <?php endif; ?>><?php echo e($exam['exam_name']); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php 
                                                        } 
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="paper_name" class="form-control"  value="<?php echo e($paper->paper_name); ?>"/ autocomplete="off"> </div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo e(route('papers')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
										</div>
									</div>
                                </div>
													</form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/paper/edit.blade.php ENDPATH**/ ?>