                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="<?php echo e(route('subjectUpdate',['id'=> Hasher::encode($subject->id) ])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="exam_id" id="exam_id" class="form-control"> 
                                                            ...
                                                            <option value="<?php echo e($exam['id']); ?>" <?php echo e(($subject->exam_id==$exam['id'])?"selected":""); ?>><?php echo e($exam['exam_name']); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="subject_name" class="form-control"  value="<?php echo e($subject->subject_name); ?>"/ autocomplete="off"> </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/subject/edit.blade.php ENDPATH**/ ?>