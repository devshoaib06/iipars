                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption ">
                                    <i class="icon-user "></i>
                                    <span class="caption-subject sbold ">  Mock Template Details List</span>
                                </div>
                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
											...
											?> 
                                           <div class="btn-group">
                                                <a href="<?php echo e(route('createMockTemplateDetails')); ?>"><button id="sample_editable_1_new" class="btn sbold green"> Add New
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="employer_list">
                                        <thead>
                                            <tr role="row" class="heading">	
                                                ...
                                                <th width="20%"> Number of Question </th>
                                               
                                                <th width="15%"> Marks per Question </th>
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="name" class="form-control form-filter input-sm" >
                                                </td>
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "<?php echo e(url(route('ajaxMockTemplateDetailsList'))); ?>", // ajax source					
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/template_details/list.blade.php ENDPATH**/ ?>