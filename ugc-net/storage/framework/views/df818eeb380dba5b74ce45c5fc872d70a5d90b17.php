                                    ...
                                    <div class="form-body">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-5">
												...
												<?php else: ?>
												<textarea class="form-control" rows="3" name="<?php echo $v->setting_id; ?>" id="textarea"><?php echo e($v->content); ?></textarea> 
												<?php endif; ?>
											</div>
                                        </div>
        ...
        var form1 = $('#form_sample_1');
                ...
                errorElement: 'span', //default input error message container
                        ...
                        <?php echo e($v->setting_id); ?>: {
                        	required: true,
                            <?php if( $v->setting_id == 'commission_percentage'): ?>
                            min: 1
                            <?php endif; ?>
                        },
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/settings/mock-test/addedit.blade.php ENDPATH**/ ?>