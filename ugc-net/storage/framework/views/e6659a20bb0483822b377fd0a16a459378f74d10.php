			...
			<div class="col-sm-6 col-md-3">
				...
				<div class="widget">
					...
					<ul class="list-border">
						...
						<li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/privacy_policy">Privacy Policy</a></li>

						<li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/terms-conditions">Terms & Conditions</a></li>
			...
			<div class="col-sm-6 col-md-3">
				...
				<div class="widget">
					...
					<ul class="list-border">
						...
						<li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/upcoming_courses">Upcoming Courses</a></li>
            ...
            <div class="modal-content">
                <div class="logincont">
                    ...
                    <div class="row bottomlink">
                        <div class="col-sm-6"><a href="<?php echo e(route('sign-up')); ?>">Don't have an account? Sign up now</a>
                        </div>
...
<!-- ------------------Alert------------------------- -->
 ...
 <script src="<?php echo e(asset('public/frontend/js/jquery-2.2.4.min.js')); ?>"></script>
 <script src="<?php echo e(asset('public/frontend/js/jquery-ui.min.js')); ?>"></script>
 <script src="<?php echo e(asset('public/frontend/js/bootstrap.min.js')); ?>"></script>
 <!-- JS | jquery plugin collection for this theme -->
 <script src="<?php echo e(asset('public/frontend/js/jquery-plugin-collection.js')); ?>"></script>

 <!-- Revolution Slider 5.x SCRIPTS -->
 <script src="<?php echo e(asset('public/frontend/js/revolution-slider/js/jquery.themepunch.tools.min.js')); ?>"></script>
 <script src="<?php echo e(asset('public/frontend/js/revolution-slider/js/jquery.themepunch.revolution.min.js')); ?>"></script>
 ...
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.actions.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.carousel.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.kenburn.min.js')); ?>">
 </script>
 <script type="text/javascript"
   src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js')); ?>"></script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.migration.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.navigation.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.parallax.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.slideanims.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.video.min.js')); ?>">
 </script>
 <script type="text/javascript" src="<?php echo e(asset('public/frontend/js/jquery.simpleTicker.js')); ?>"></script>
...
<?php /**PATH /var/www/html/iipars/ugc-net/resources/views/frontend/includes/footer.blade.php ENDPATH**/ ?>