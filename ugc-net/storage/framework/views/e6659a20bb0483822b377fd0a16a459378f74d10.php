            ...
            <div class="col-sm-6 col-md-3">
                ...
                <div class="widget">
                    ...
                    <ul class="list-border">
                        ...
                        <li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/privacy_policy">Privacy Policy</a>
                        </li>

                        <li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/terms-conditions">Terms &
                                Conditions</a></li>
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <div class="widget">
                    ...
                    <ul class="list-border">
                        ...
                        <li><a href="<?php echo e(config('path.iipars_base_url')); ?>/cms/page/upcoming_courses">Upcoming
                                Courses</a></li>
        ...
        <div class="modal-dialog modal-sm vertical-align-center" role="document">
            <div class="modal-content">
                <div class="logincont">
                    ...
                    <div class="poplogo"><img src="<?php echo e(config('path.iipars_base_url')); ?>/assets/images/new-aeducation-logo.png" alt="India’s no.1 online study material for UGC NET
                    " /></div>
                    <h2>Login</h2>
                    ...
                    <div class="row bottomlink">
                        <div class="col-sm-6"><a href="<?php echo e(route('sign-up')); ?>">Don't have an account? Sign up
                                now</a>
                        </div>
...
<script src="<?php echo e(config('path.iipars_base_url')); ?>/assets/js/custom.js"></script>


<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.actions.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.carousel.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.kenburn.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.migration.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.navigation.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.parallax.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.slideanims.min.js')); ?>">
</script>
<script type="text/javascript"
src="<?php echo e(asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.video.min.js')); ?>">
</script>
...
<script type="text/javascript">
    $("#frmx").validate({
        ...
        submitHandler: function(form) {
            ...
            let url = "<?php echo e(url('userlogin')); ?>";
