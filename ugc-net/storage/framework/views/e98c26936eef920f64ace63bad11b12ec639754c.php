            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-6 col-md-offset-3 col-sm-offset-2">
                    <div class="resellerCont">
                        ...
                        <form action="<?php echo e(route('resellerloginAction')); ?>" id="contributorlogin" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <p>
                                Forgot password? <a href="<?php echo e(route('resellerforgotpassword')); ?>">Click here</a>
                                </p>
                            </div>
                            <input type="submit" value="Login Now">
                        </form>
                        <p style="float: left; margin-top: 10px;">
                            Don't have an account? <a href="<?php echo e(route('reseller-sign-up')); ?>">Signup now</a>
                        </p>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.layout_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/frontend/reseller/auth/login.blade.php ENDPATH**/ ?>