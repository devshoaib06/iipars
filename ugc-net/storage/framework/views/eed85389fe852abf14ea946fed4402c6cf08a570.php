    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<?php echo e(url(config('constants.admin_prefix'))); ?>" class="page-unload-prevent">
                <img src="<?php echo e(config('path.assets_path')); ?>/assets/layouts/layout/img/logo.jpg" alt="logo"
                    class="logo-default" />
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                        ...
                        <img alt="<?php echo Auth::guard('admins')->user()->name; ?>" class="img-circle"
                            src="<?php echo e(config('path.assets_path')); ?>/assets/layouts/layout/img/avatar.png" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="<?php echo e(url(config('path.iipars_admin_base_url') . '/index.php/profile/profile_view/'.$iipars_admin_id)); ?>"
                        ...
                        ?>
                        <li>
                            <a href="<?php echo e(url(config('constants.admin_prefix') . '/logout')); ?>"
                                class="page-unload-prevent">
