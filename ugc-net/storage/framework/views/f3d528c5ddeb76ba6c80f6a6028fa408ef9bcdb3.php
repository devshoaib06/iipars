                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption ">
                                    <i class="icon-user "></i>
                                    <span class="caption-subject sbold ">  Mock Exam List</span>
                                </div>
                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            ?> 
                                            <form id="declare-result" action="<?php echo e(route('declareMockExamResult')); ?>" method="POST" >
                                                <?php echo csrf_field(); ?>
                                                <div class="btn-group">
                                                        
                                                            <button type="submit" id="sample_editable_1_new" class="btn sbold green"> Declare Result
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="employer_list">
                                        <thead>
                                            <tr role="row" class="heading">	
                                                ...
                                                <th width="15%"> Winner Position </th>
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "<?php echo e(url(route('ajaxmockexamlist'))); ?>", // ajax source					
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/exam/list.blade.php ENDPATH**/ ?>