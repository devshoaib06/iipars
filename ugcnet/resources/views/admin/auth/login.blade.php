...
<html lang="en">
    ...
    <head>
        ...
        <title>{{config('constants.site_name')}} | Admin Login <?php /*{{trans('common.page_title.login')}} - {{config('constants.site_name')}}*/?></title>

        <base href="{{config('path.main_site_path')}}" >
	...
	<body class=" login">
        <div class="login-header">
            <div class="copyright" > Welcome  {{config("constants.site_name")}} </div>
        ...
        <div class="logo">
            ...
            <a href="{{ url(config("constants.admin_prefix")) }}">

                <img src="{{ asset('public/assets/pages/img/logo-big.jpg') }}" alt="" /> </a>
        ...
        <div class="content">
			...
			<form class="login-form" action="{{ url(config('constants.admin_prefix').'/login') }}" method="post">
			...
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
				...
				@if ($errors->has('token_error'))
					...
					<div class="alert alert-danger ">
						...
						<span>{{ $errors->first('token_error') }}</span>
            ...
            <form class="forget-form" action="{{ url(config('constants.admin_prefix').'/password/email') }}" method="post">
...
<!-- ------------------Alert------------------------- -->
        ...
        <div class="login-footer">
            <div class="copyright"> {{date('Y')}} &copy; {{config("constants.site_name")}}. </div>
				...
				rules: {
					...
					email: {
...

						{
							...
							url: "{{ url(config('constants.admin_prefix').'/isregister/email') }}",
