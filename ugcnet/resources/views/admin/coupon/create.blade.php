                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject  sbold ">Add Coupon
                                    </span>
                                </div>
                                <!--<div class="actions">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="{{route('createCoupons')}}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="coupon_name" class="form-control"  value="{{ old('coupon_name') }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="price" class="form-control"  value="{{ old('price') }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="coupon_code" id="randomfield" class="form-control"  value="{{ old('coupon_code') }}"/ autocomplete="off"> </div>
                                            <div class="col-md-3">
                                                <a href="javascript:void(0)" onClick="randomString();">Generate Coupon Code</a>
                                            </div>

                                        </div> <!--First Name-->
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Uses Per Student
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="uses_per_student" class="form-control"  value="{{ old('uses_per_student') }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control  date-picker" name="start_date" size="16" type="text" value="{{ old('start_date') }}" / autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control  date-picker" name="end_date" size="16" type="text" value="{{ old('end_date') }}" / autocomplete="off">
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="{{ route('coupons') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
var form1 = $('#form_sample_1');
    ...
    errorElement: 'span', //default input error message container
            ...
            messages: {
                ...
                uses_per_student: {
                    required: 'USes Per Student is required.',
                }
            },
...
function randomString() {
	...
	var string_lengthchar = 4;
	var string_lengthnum = 2;
	var randomstringchar = '';
	var randomstringnumber = '';
	for (var i=0; i<string_lengthchar; i++) {
		var rnum = Math.floor(Math.random() * chars.length);
		randomstringchar += chars.substring(rnum,rnum+1);
	}
	for (var i=0; i<string_lengthnum; i++) {
		var rnum = Math.floor(Math.random() * Number.length);
		randomstringnumber += Number.substring(rnum,rnum+1);
	}
	$("#randomfield").val(randomstringchar+randomstringnumber);
