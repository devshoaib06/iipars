                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('materialUpdate',['id'=> Hasher::encode($material->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="material_name" class="form-control"  value="{{ $material->material_name }}"/ autocomplete="off"> </div>
