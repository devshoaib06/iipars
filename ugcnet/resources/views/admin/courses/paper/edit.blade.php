                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('paperUpdate',['id'=> Hasher::encode($paper->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
                                                ...
                                                <select name="exam_id" id="exam_id" class="form-control"> 
                                                   <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="{{$exam['id']}}" @if(isset($paper->exam_id) && $paper->exam_id==$exam['id']) selected="selected" @endif>{{$exam['exam_name']}}</option>
                                                        @endforeach
                                                    <?php 
                                                        } 
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="paper_name" class="form-control"  value="{{ $paper->paper_name }}"/ autocomplete="off"> </div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="{{ route('papers') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
										</div>
									</div>
                                </div>
													</form>
