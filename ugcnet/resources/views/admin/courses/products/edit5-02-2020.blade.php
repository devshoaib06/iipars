                                                    ...
                                                    <ul>
                                                        ...
                                                        @foreach($items as $item_key=>$item_val)
                                                         ...
                                                         <li class="mt-list-item">
                                                            <div class="list-todo-icon bg-white material-list" data-itemid="{{@$item_val[0]->item_id}}" data-target="#task-{{$i}}" data-toggle="collapse">
                                                                
                                                                <input type="checkbox" name="materials[]" class="checkbox_check"
                                                                   value="{{@$item_val[0]->item_id}}"
                                                                   {{$product_contributor_item[$i-1]>0?"checked":''}}
                                                                >
                                                            </div>
                                                            <div class="list-todo-item dark">
                                                                <a class="list-toggle-container">
                                                                    <div class="list-toggle done uppercase">
                                                                        <div class="list-toggle-title bold">{{$item_key}}</div>
                                                                        {{-- <div class="badge badge-default pull-right bold">3</div> --}}
                                                                    </div>
                                                                </a>
                                                                <div class="task-list panel-collapse collapse {{$product_contributor_item[$i-1]>0?'in':''}}" id="task-{{$i}}">
                                                                    <ul class="contributor_list">
                                                                      @foreach($item_val as $item)
                                                                        <?php 
                                                                            $myfunction = new App\library\myFunctions(); 

                                                                            $item_price=$myfunction->getContributorItemPrice($item,$product->product_id);
                                                                        ...
                                                                        <li class="task-list-item done" >
                                                                            <div class="row">
                                                                                <div class="form-group col-sm-3">
                                                                                    <input type="checkbox" class="contributor_check" name="contributor[]" {{$item_price?'checked':''}} value="{{$item->contributor_id}}"

                                                                                    > {{$item->firstname}} {{$item->lastname}} </div>
                                                                                <div class="form-group col-sm-3">
                                                                                    <label class="control-label">Price</label>
                                                                                    <input type="text" name="price[]" class="form-control contributor_price" value="{{$item_price}}" {{$item_price?'':'disabled'}} >
                                                                                    <input type="hidden" name="item_id[]" class="form-control contributor_price"  {{$item_price?'':'disabled'}} value="{{$item->item_id}}"> 
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                      @endforeach
