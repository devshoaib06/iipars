                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('subjectUpdate',['id'=> Hasher::encode($subject->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="exam_id" id="exam_id" class="form-control"> 
                                                            ...
                                                            <option value="{{$exam['id']}}" {{($subject->exam_id==$exam['id'])?"selected":""}}>{{$exam['exam_name']}}</option>
                                                            @endforeach
