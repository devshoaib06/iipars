...
<html lang="en">
    ...
    <head>
		...
		<meta name="description" content="@if (trim($__env->yieldContent('meta_description')))@yield('meta_description') @else {{config('constants.site_name')}} @endif" />
		<meta name="keywords" content="@if (trim($__env->yieldContent('meta_keywords')))@yield('meta_keywords') @else {{config('constants.site_name')}} @endif" />
...
<!-- ------------------Alert------------------------- -->
		...
		@yield('page_level_scripts_extreme_end') 	
