                                ...
                                <form action="{{$form_url}}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select name="rule_id" id="rule_id" class="form-control">
                                                    ...
                                                    @foreach ($tabrules as $tabrule)
                                                    <option value="{{$tabrule['id']}}" 
                                                    @if(isset($mocktemplate))
                                                        @if($mocktemplate->rule_id == $tabrule['id']) selected @endif
                                                    @endif
                                                    >{{$tabrule['name']}}</option>
                                                    @endforeach
                                                </select> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input type="text" name="correctness" value="{{isset($mocktemplate)?$mocktemplate->correctness:''}}" class="form-control" />
                                            @if ($errors->has('correctness'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('correctness') }}</strong>
                                            </span>
                                            @endif
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input type="text" name="marks" value="{{isset($mocktemplate)?$mocktemplate->marks:''}}" class="form-control" />
                                            @if ($errors->has('marks'))
                                            <span class="help-block">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="{{ route('showMockTabRuleDetailsList') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
