                                    ...
                                    <div class="form-body">
                                        ...
                                        @for ($i = 1; $i < 5; $i++)
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                <input type="text" name="options{{$i}}" class="form-control"  value="{{old('options'.$i)}}"/> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select name="correct" id="correct" class="form-control">
                                                    ...
                                                    @for ($j = 1; $j < 5; $j++)
                                                        <option value="options{{$j}}" >Option #{{$j}}</option>
                                                    @endfor
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                {{-- <input type="text" name="question" class="form-control"  value="{{old('question')}}"/>  --}}
                                                <textarea name="correct_clarification" rows="8" class="form-control" >{{old('correct_clarification')}}</textarea>
                                            </div>
