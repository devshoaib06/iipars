            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="{{ url(config("constants.admin_prefix")) }}" class="page-unload-prevent">
                        <img src="{{config('path.assets_path')}}/assets/layouts/layout/img/logo.jpg" alt="logo" class="logo-default" /> </a>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								...
								<img alt="<?php echo Auth::guard('admins')->user()->name; ?>" class="img-circle" src="{{config('path.assets_path')}}/assets/layouts/layout/img/avatar.png" />
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="{{ url(config('constants.admin_prefix').'/profile') }}" class="page-unload-prevent">
                                ...
                                <li>
                                    <a href="{{ url(config('constants.admin_prefix').'/logout') }}" class="page-unload-prevent">
