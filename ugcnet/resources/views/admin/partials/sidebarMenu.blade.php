<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
    ...
    <li class="nav-item  @if ($menu_parent == 'users')  active open @endif">
        ...
        <ul class="sub-menu">
            <li class="nav-item  @if ($menu_child == 'students')  active open @endif">
                <a href="{{ config('path.iipars_admin_base_url') }}/index.php/sub_admin_list_manage"
                    class="nav-link ">
                    <!--<i class="icon-user"></i>-->
    ...
    <li class="nav-item  @if ($menu_parent == 'users')  active open @endif">
        ...
        <ul class="sub-menu">
            ...
            <li class="nav-item  @if ($menu_child == 'students')  active open @endif">
                <a href="{{ config('path.iipars_admin_base_url') }}/index.php/Admin_service/kpo_view"
                    class="nav-link ">
                    <!--<i class="icon-user"></i>-->
                    <i class="fa fa-list" aria-hidden="true"></i>
            ...
            <li class="nav-item  @if ($menu_child == 'students')  active open @endif">
                <a href="{{ config('path.iipars_admin_base_url') }}/index.php/manage_news_feed"
                    class="nav-link ">
                    <!--<i class="icon-user"></i>-->
                    <i class="fa fa-list" aria-hidden="true"></i>
    ...
    <li class="nav-item  @if ($menu_parent == 'users')  active open @endif">
        ...
        <ul class="sub-menu">
            <li class="nav-item  @if ($menu_child == 'students')  active open @endif">
                <a href="{{ config('path.iipars_admin_base_url') }}/index.php/manage_slider/ceo"
                    class="nav-link ">
                    <!--<i class="icon-user"></i>-->
                    <i class="fa fa-list" aria-hidden="true"></i>
    ...
    <li class="nav-item  @if ($menu_parent == 'users')  active open @endif">
        ...
        <ul class="sub-menu">
            <li class="nav-item  @if ($menu_child == 'students')  active open @endif">
                <a href="{{ config('path.iipars_admin_base_url') }}/index.php/manage_user_student"
                    class="nav-link ">
                    <i class="fa fa-list" aria-hidden="true"></i>
