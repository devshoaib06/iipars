                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">Email Template</span>
                                </div>
                                <!--<div class="actions">
                                ...
                                <form action="{{$form_url}}" id="form_sample_1" class="form-horizontal" method="POST">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4"><input type="text" name="subject" class="form-control" value="@if (isset($tmpl->subject)){{$tmpl->subject}}@endif" /> </div>
                                        </div>                                         
                                        
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Content <span class="required"> * </span></label>
                                            <div class="col-md-8"><textarea class="ckeditor form-control" rows="3" name="content" data-error-container="#content_error" id="em_content">@if (isset($tmpl->content)){{$tmpl->content}}@endif</textarea> 
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="{{ url(config("constants.admin_prefix").'/email-template') }}"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
