                            ...
                            <div class="portlet-body">
                                ...
                                <form action="{{$form_url}}" id="form_sample_1" class="form-horizontal" method="POST" >
                                    ...
                                    <div class="form-body">
										...
										@if (in_array($v->id,$except_setting))
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="radio-list">
                                                        <label class="radio-inline" for="status-inline-radio3">
                                                            ...
                                                            <input type="radio" name="<?php echo $v->setting_id; ?>" id="status-inline-radio3" class="form-control  numbers " value="1" {{$v->content==1?'checked':''}}    />Test
                                                        </label>
                                                        <label class="radio-inline" for="status-inline-radio4">
                                                            
                                                            <input type="radio" id="status-inline-radio4" name="<?php echo $v->setting_id; ?>" class="form-control  numbers " value="2" {{$v->content==2?'checked':''}}   /> Production
                                        ...
                                        @elseif(!in_array($v->id,$except_setting))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    @else
                                                    <textarea class="form-control" rows="3" name="<?php echo $v->setting_id; ?>">{{$v->content}}</textarea> 
                                                    @endif
                                                </div>
                                            </div>
                                        @endif
...
// http://docs.jquery.com/Plugins/Validation
        ...
        var form1 = $('#form_sample_1');
                ...
                errorElement: 'span', //default input error message container
                        ...
                        {{$v->setting_id}}: {
                        	required: true,
                            @if ( $v->setting_id == 'reseller_commision')
                            min: 1
                            @endif
                            @if ( $v->setting_id == 'student_cashback')
                            min: 0
                            @endif
                        },
                        @endforeach	
