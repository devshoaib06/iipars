                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="{{ route('testimonialUpdate',['id'=> Hasher::encode($testimonial->id) ]) }}" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										{!! csrf_field() !!}
										<div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="student_name" class="form-control"  value="{{ $testimonial->student_name }}"/ autocomplete="off"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="student_course" class="form-control" value="{{ $testimonial->student_course }}" autocomplete="off" /> </div>
                                            ...
                                            <select class="form-control" name="testimonial_type" id="testimonial_type">
                                                    ...
                                                    <option value="1" @if( $testimonial->testimonial_type == 1 ) selected @endif>Video</option>
                                                    <option value="2" @if( $testimonial->testimonial_type == 2 ) selected @endif>Text</option>
                                                </select>
                                        ...
                                        <div class="form-group" @if( $testimonial->testimonial_type == 1) style="display:block;" @else  style="display:none;"  @endif id="video_block">
                                            <label class="control-label col-md-3">Video URL
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="video_url"  id="video_url" class="form-control" value="{{ $testimonial->video_url }}" autocomplete="off" /> </div>

                                        </div> <!--Last Name-->

                                        <div class="form-group"  @if( $testimonial->testimonial_type == 2) style="display:block;" @else  style="display:none;" @endif id="testimonial_block">
                                            <label class="control-label col-md-3">Testimonial Content
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6"> 
                                                <textarea name="testimonial_text" id="pdesc" rows="20" cols="50" class="form-control" />{{ $testimonial->testimonial_text }}</textarea>
