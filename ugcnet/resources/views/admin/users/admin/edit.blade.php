												...
												<div class="row">
													<div class="col-md-3">
														<ul class="list-unstyled profile-nav">
															<li>
																<img src="{{config('path.assets_path')}}/assets/layouts/layout/img/avatar.png" class="img-responsive pic-bordered" alt="" />
													...
													<div class="col-md-9">
														<div class="row">
															...
															<h1 class="font-green sbold uppercase">{{$user_info->name}}</h1>
																	...
																	<div class="form-group">
																		<div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				...
																				<img src="{{config('path.assets_path')}}/assets/layouts/layout/img/avatar.png" alt="" />
													                    ...
													                    <br/><span style="color:RED;"><small>{{$errors->first('profile_pic')}}</small></span>
													                    @endif
