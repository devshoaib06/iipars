                                                ...
                                                <div class="col-md-9">
                                                    <div class="tab-content">
                                                            ...
                                                            <form action="{{route('contributor-update',['id'=>Hasher::encode($user_info->id)])}}" id="user_info_form"  method="POST">
																...
																<div class="form-group">
																	 <label class="control-label">Another Contact Number</label>
																		<input type="text" name="anothercontactnumber" class="form-control" id="anothercontactnumber" value="{{$user_info->anothercontactnumber}}"/> 
																</div>
																...
																<div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{$user_info->qualification}}" class="form-control" name="qualification"/> 
                                                                </div>
                                                                <div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="checkbox-list subject-list">
																	   @foreach ($allSubjects as $subject)
																		<label class="checkbox-inline" for="example-inline-checkbox{{$subject->id}}">
																		<input id="example-inline-checkbox{{$subject->id}}" type="checkbox" value="{{$subject->id}}"
                                                        ...
                                                        <div id="tab_2-1" class="tab-pane">
                                                            ...
                                                            <form action="{{route('contributor-bankdetails-update',['id'=>Hasher::encode($user_info->id)])}}" id="password_checking"  method="POST">
                                                                {!! csrf_field() !!}
                                                                <div class="form-group">
