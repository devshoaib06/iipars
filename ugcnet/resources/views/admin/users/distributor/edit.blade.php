                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    ...
                                    <a href="{{route('distributors')}}" class="btn default">Back</a>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                        <div class="col-md-8 profile-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4"><h2 class="tag_fields">Commission</h2></div>
                                                                <div class="col-md-4">{{$user_info->commission}}</div>
                                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="tab-content">
                                                        <div id="tab_1-1" class="tab-pane active">
                                                            <form action="{{route('distributor-update',['id'=>Hasher::encode($user_info->id)])}}" id="user_info_form"  method="POST">
                                                                ...
                                                                {{-- <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="commission" class="form-control" id="commission" value="{{$user_info->commission}}"/> 
                                                                </div> --}}
                                                                <div class="form-group">
                                                                    <label class="control-label">Referral Code</label>
                                                                    
                                                                     <input type="text" name="slug" class="form-control" id="slug" value="{{$user_info->reseller_code}}" disabled /> 
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div id="tab_2-1" class="tab-pane">
                                                            <form action="{{route('distributor-bankdetails-update',['id'=>Hasher::encode($user_info->id)])}}" id="password_checking"  method="POST">
                                                                {!! csrf_field() !!}
                                                                <div class="form-group">
                                                                    <label class="control-label">A/C Holder Name</label>
																	<input type="text" class="form-control" name="ac_holder_name" value="{{isset($bankdetails)?$bankdetails->ac_holder_name:''}}"/>
																</div>
                                                                <div class="form-group">
                                                                    <label class="control-label">A/C No.</label>
																	<input type="text" class="form-control" name="account_number" value="{{isset($bankdetails)?$bankdetails->account_number:''}}"/>
																</div>
                                                                <div class="form-group">
                                                                    <label class="control-label">Bank Name</label>
																	<input type="text" class="form-control" name="bank_name" value="{{isset($bankdetails)?$bankdetails->bank_name:''}}"/>
																</div>
                                                                <div class="form-group">
                                                                    <label class="control-label">Branch</label>
																	<input type="text" class="form-control" name="bank_branch" value="{{isset($bankdetails)?$bankdetails->bank_branch:''}}"/>
																</div>
                                                                <div class="form-group">
                                                                    <label class="control-label">IFSC Code</label>
																	<input type="text" class="form-control" name="ifsc_code" value="{{isset($bankdetails)?$bankdetails->ifsc_code:''}}"/>
																</div>
                                                        ...
                                                        <div id="tab_3-3" class="tab-pane">
                                                            ...
                                                            <form action="{{route('distributor-password-update',['id'=>Hasher::encode($user_info->id)])}}" id="password_checking"  method="POST">
                                                                {!! csrf_field() !!}
                                                                <div class="form-group">
