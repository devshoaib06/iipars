                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
											...
											?> 
                                           <div class="btn-group">
                                                <a href="{{ route('createStudent')}}"><button id="sample_editable_1_new" class="btn sbold green"> Add New
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "{{ url(config("constants.admin_prefix").'/ajax-student-list') }}", // ajax source					
                        },
