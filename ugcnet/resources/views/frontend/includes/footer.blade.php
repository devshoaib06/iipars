          ...
          <div class="col-sm-6 col-md-3">
              <div class="widget">
                  ...
                  <ul class="list-border">
                      <li><a href="https://iipars.com/privacy-policy">Privacy Policy</a></li>
                      <li><a href="https://iipars.com/terms-conditions">Terms & Conditions</a></li>
                  </ul>
              </div>
              <div class="widget">
                  ...
                  <ul class="styled-icons icon-dark mt-20">
                      ...
                      <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s" data-wow-offset="10"><a
                              href="https://twitter.com/" data-bg-color="#02B0E8"><i class="fa fa-twitter"></i></a>
                      </li>
                      <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".3s" data-wow-offset="10"><a
                              href="https://www.skype.com/en/" data-bg-color="#05A7E3"><i class="fa fa-skype"></i></a>
                      </li>
                      <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".4s" data-wow-offset="10"><a
                              href="https://myaccount.google.com" data-bg-color="#A11312"><i
                                  class="fa fa-google-plus"></i></a>
                      </li>
                      <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".5s" data-wow-offset="10"><a
                              href="https://www.youtube.com" data-bg-color="#C22E2A"><i class="fa fa-youtube"></i></a>
                      </li>
                  </ul>
              </div>
          </div>
          ...
          <div class="col-sm-6 col-md-3">
              <div class="widget">
                  ...
                  <ul class="list-border">
                      ...
                      <li><a href="https://iipars.com/manage_ebook">Invitation for E-Book</a></li>
                      <li><a href="https://iipars.com/plan">Plan</a></li>
                  </ul>
              </div>
          </div>
          <div class="col-sm-6 col-md-3">
              ...
              <div class="widget">
                  ...
                  <ul class="list-inline mt-5">
                      ...
                      <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a
                              class="text-gray" href="#">info.iipars@gmail.com</a> </li>

                      <br>


                      <!-- <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">46967</a> </li> -->
                      <li class="number_of_view_cls"><span class="number_of_view">No. of Visitor:46967</span></li>
      ...
      <div class="container pt-10 pb-10 pb-0">
          <div class="row">
              <div class="col-md-7 sm-text-center text-white">
                  <p class="font-13 m-0">Copyright &copy;2021 International Institute For Providing Academic And
                      Research
                      Supports. All Rights Reserved</p>
              </div>
            ...
            <div class="modal-content">
                <div class="logincont">
                    ...
                    <div class="row bottomlink">
                        <div class="col-sm-6"><a href="{{route('sign-up')}}">Don't have an account? Sign up now</a>
                        </div>
...
<!-- ------------------Alert------------------------- -->
 ...
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.actions.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.carousel.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.kenburn.min.js')}}">
 </script>
 <script type="text/javascript"
   src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.migration.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.navigation.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.parallax.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.slideanims.min.js')}}">
 </script>
 <script type="text/javascript" src="{{asset('public/frontend/js/revolution-slider/js/extensions/revolution.extension.video.min.js')}}">
 </script>
