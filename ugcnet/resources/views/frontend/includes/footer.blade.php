...
<footer>
  ...
  <div class="col-sm-3 col-md-4">
    <img src="{{ asset('public/frontend/images/logo.png') }}"  alt="India’s no.1 online study material for UGC & CSIR NTA NET/SET/JRF" class="img-responsive" />
<p>&nbsp;</p>
<h3>Call us at:</h3>
<ul>
  ...
  <div class="col-sm-3 col-md-2">
    ...
    <a href="https://play.google.com/store/apps/details?id=com.edu.teachinns" class="app-store"><img src="{{ asset('public/frontend/images/android-app.png') }}" class="img-responsive"></a>
    </div>
	  {{-- <div class="visitbox">
    @php 
...
@if($floatersignup!=null)

  @php 
    $timetoshowPopup=$floatersignup->time*1000;
  @endphp
  @include('frontend.includes.modal.floater_sign')
@endif
<!-- Bootstrap Js --> 
