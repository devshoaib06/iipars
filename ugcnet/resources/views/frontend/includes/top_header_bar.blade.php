    ...
    <div class="container pt-20 pb-20 p_cus_mobile_all_header_ppp">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3">
          <a class="menuzord-brand pull-left flip sm-pull-center" href="https://iipars.com/"><img
              src="https://iipars.com/assets/images/new-aeducation-logo.png" alt=""></a>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-9 text-ali-rt text-ce-res">
            ...
            <div class="hed-cont widget mt-10 mb-10 m-0 res-none">
              <a class="btn mt-10 trans-btn"
                ...
                <!-- <i class="fa fa-lg fa-mobile text-primary" aria-hidden="true"></i> --><img
                  src="https://iipars.karmickdev.com/ugcnet/public/frontend/images/whatsapp-M.png" alt="Whatsapp"
          ...
          <div class="hed-cont widget mt-10 mb-10 m-0 login_p_cus_mobile">
            <a class="btn mt-10 btn-success" href="https://iipars.com/sign-in"><i class="fa fa-sign-in"
        ...
        <div class="pull-right sm-pull-none mb-sm-15 pr-15 all_app_download_api_score_entry_lavel_p_cus">
          ...
          <a target="_blank" class="res-app-change btn btn-colored btn-flat btn-theme-colored2 mt-10 round-btn" href="https://iipars.com/Manage_api">Check your API score</a>

          <a target="_blank" class="res-app-change btn btn-colored btn-flat btn-theme-colored2 mt-10 round-btn" href="https://iipars.com/Manage_entry_level_score"></i>Entry level score checking</a> -->
        </div>
