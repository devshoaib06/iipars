                    ...
                    <div class="col-sm-12 col-md-7 col-lg-7">
                        <form action="{{route('submitStudentAnwser')}}" method="POST"    id="mt_test" >
                                ...
                                <div class="questionCont">
                                        ...
                                        <div class="btnDiv">
                                            <button type="submit" id="draftBtn" class="submitbtn btn btn-draft">Mark</button>
                                            <button type="submit" id="skipBtn" class=" submitbtn btn btn-default">Skip</button>
                                            <button type="button" id="nextBtn" class="submitbtn  btn btn-primary">Save & Next</button>
                                        </div>
                                    </div>
