                            ...
                            <div class="portlet-body">
                                ...
                                <form action="<?php echo e($form_url); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select name="rule_id" id="rule_id" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $tabrules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tabrule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tabrule['id']); ?>" 
                                                    <?php if(isset($mocktemplate)): ?>
                                                        <?php if($mocktemplate->rule_id == $tabrule['id']): ?> selected <?php endif; ?>
                                                    <?php endif; ?>
                                                    ><?php echo e($tabrule['name']); ?></option>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Correctness
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                            <input type="text" name="correctness" value="<?php echo e(isset($mocktemplate)?$mocktemplate->correctness:''); ?>" class="form-control" />
                                            <?php if($errors->has('correctness')): ?>
                                            <span class="help-block">
                                                <strong><?php echo e($errors->first('correctness')); ?></strong>
                                            </span>
                                            <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input type="text" name="marks" value="<?php echo e(isset($mocktemplate)?$mocktemplate->marks:''); ?>" class="form-control" />
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="<?php echo e(route('showMockTabRuleDetailsList')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/tabulation_rule_details/_form.blade.php ENDPATH**/ ?>