                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    ...
                                    <a href="<?php echo e(route('distributors')); ?>" class="btn default">Back</a>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="tab-content">
                                                        <div id="tab_1-1" class="tab-pane active">
                                                            <form action="<?php echo e(route('distributor-update',['id'=>Hasher::encode($user_info->id)])); ?>" id="user_info_form"  method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label">Referral Code</label>
                                                                     ...
                                                                     <input type="text" name="slug" class="form-control" id="slug" value="<?php echo e($user_info->reseller_code); ?>" disabled /> 
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div id="tab_2-1" class="tab-pane">
                                                            <form action="<?php echo e(route('distributor-bankdetails-update',['id'=>Hasher::encode($user_info->id)])); ?>" id="password_checking"  method="POST">
                                                                <?php echo csrf_field(); ?>
                                                        ...
                                                        <div id="tab_3-3" class="tab-pane">
                                                            ...
                                                            <form action="<?php echo e(route('distributor-password-update',['id'=>Hasher::encode($user_info->id)])); ?>" id="password_checking"  method="POST">
                                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/users/distributor/edit.blade.php ENDPATH**/ ?>