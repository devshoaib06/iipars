                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
											...
											?> 
                                           <div class="btn-group">
                                                <a href="<?php echo e(route('createQuestion')); ?>"><button id="sample_editable_1_new" class="btn sbold green"> Add New
                                            ...
                                            <tr role="row" class="filter">
												...
												<td>
                                                    <select name="option_type" class="form-control form-filter input-sm">
                                                        ...
                                                        <?php $__currentLoopData = $option_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$option_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($key); ?>"><?php echo e($option_type); ?></option>
...
<script type="text/javascript">
        ...
        var question_id=$(this).data('value');
            ...
            var url="<?php echo e(route('ajaxQuestionDelete')); ?>";
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "<?php echo e(url(route('ajaxMockQuestionList'))); ?>", // ajax source					
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/mock-test/questions_master/list.blade.php ENDPATH**/ ?>