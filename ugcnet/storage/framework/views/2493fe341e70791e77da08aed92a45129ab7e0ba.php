                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject  sbold ">Edit News
                                    </span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo e(route('newsFeedUpdate',['id'=>Hasher::encode($newsfeed->id)])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">News
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                
                                                <textarea name="newsfeed" id="newsfeed"  class="form-control" rows="5" cols="7"><?php echo e($newsfeed->newsfeed); ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control  date-picker" name="start_date" size="16" type="text" value="<?php echo e(old('start_date')); ?>" / autocomplete="off">
                                        </div>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <input class="form-control  date-picker" name="end_date" size="16" type="text" value="<?php echo e(old('end_date')); ?>" / autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="status" <?php echo e($newsfeed->status==1?'checked':''); ?>> Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="status" <?php echo e($newsfeed->status==0?'checked':''); ?>> Inactive</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                    </div>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="<?php echo e(route('newsfeed')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/newsfeed/edit.blade.php ENDPATH**/ ?>