                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption ">
                                    <i class="icon-user "></i>
                                    <span class="caption-subject sbold ">  Payment Request List</span>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="employer_list">
                                        <thead>
                                            <tr role="row" class="heading">	
                                                ...
                                                <th width="15%"> Requested User Type </th>
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td>
                                                    <select name="user_type_id" id="user_type_id" class="form-control form-filter input-sm" > 
                                                        <option value="" >Select User Type</option>
                                                        <?php $__currentLoopData = $allusertypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "<?php echo e(url(route('ajaxpaymentRequestList'))); ?>", // ajax source					
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/payment-request/list.blade.php ENDPATH**/ ?>