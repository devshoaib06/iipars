                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo e(route('createSubjects')); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-body">
                                                ...
                                                <select name="exam_id" id="exam_id" class="form-control">
                                                    <option value="">Select Exam Name</option>
                                                        <?php $__currentLoopData = $allExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($exam['id']); ?>"><?php echo e($exam['exam_name']); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="subject_name" class="form-control"  value="<?php echo e(old('subject_name')); ?>"/ autocomplete="off"> </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="<?php echo e(route('subjects')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/subject/create.blade.php ENDPATH**/ ?>