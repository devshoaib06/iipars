                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->  
                                <form action="<?php echo e(route('examUpdate',['id'=> Hasher::encode($exam->id) ])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="exam_name" class="form-control"  value="<?php echo e($exam->exam_name); ?>"/ autocomplete="off"> </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/courses/exam/edit.blade.php ENDPATH**/ ?>