                ...
                <div class="articleMonthWrap">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
                            ...
                            <h2>
                                <a href="<?php echo e(route('articleDetails',['category'=>$featured_article->cat_slug,'slug'=>$featured_article->slug])); ?>"><?php echo e($featured_article->title); ?></a>
                            </h2>
                            <div class="caption">
                                <div class="subcource">
                                    <ul>
                                ...
                                <!--<a class="articleLink" href="<?php echo e(route('articleDetails',['category'=>$featured_article->cat_slug,'slug'=>$featured_article->slug])); ?>">Read full article</a>-->
                                <ul class="catList">
                                    <li>
                                        <a href="<?php echo e(route('articles',['category'=>$featured_article->cat_slug])); ?>"><span class="categories-tag"><?php echo e($featured_article->cat_name); ?></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <?php $__empty_1 = true; $__currentLoopData = $allArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="articleWrap">
                                ...
                                <a href="<?php echo e(route('articleDetails',['category'=>$article_info->cat_slug,'slug'=>$article_info->slug])); ?>"><h2><?php echo e($article_info->title); ?></h2></a>
                                    ...
                                    <a href="<?php echo e(route('articles',['category'=>$article_info->cat_slug])); ?>"><span class="categories-tag"><?php echo e($article_info->cat_name); ?></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="allArticle">
                            <a href="<?php echo e(route('all-articles')); ?>">View All Article</a>
                        </div>
                    </div>
                </div>
                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.layout_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/frontend/articles/article.blade.php ENDPATH**/ ?>