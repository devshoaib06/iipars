                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                    ...
                                    <tbody>
										<?php $count = 0; ?>
                                        <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php ++$count; ?>
                                        <tr class="odd gradeX">
                                           <td> <?php echo e($count); ?> </td>     
                                            <td> <?php echo e($c->mail_id); ?> </td>
                                            <td> <?php echo e($c->subject); ?> </td>                                                                                      
                                            <td> <?php echo e(App\library\myFunctions::dateText($c->updated_at,'d_m_y')); ?> </td>
                                            <!--<td>
                                                <?php if($c->status == '1'): ?>
                                            ...
                                            <td>  
                                                <!--<a href="<?php echo e(url(config("constants.admin_prefix").'/cms/edit')); ?>/<?php echo e($c->id); ?>" class="btn btn-sm default btn-editable"><i class="fa fa-pencil"></i> Edit </a>-->
                                                 <a  href="<?php echo e(url(config("constants.admin_prefix").'/email-template/edit')); ?>/<?php echo e($c->id); ?>" data-toggle="tooltip" class="btn btn-default btn-sm"><i class="fa fa-edit "></i>Edit</a>
    ...
    var TableDatatablesManaged = function () {
        ...
        var table = $('#sample_1');
                ...
                "sortAscending": ": activate to sort column ascending",
                        ...
                        "lengthMenu": [
                                [<?php echo e(config("constants.LENGTH_MENU_BASIC_1")); ?>, - 1],
                                [<?php echo e(config("constants.LENGTH_MENU_BASIC_2")); ?>, "All"] // change per page values here
                        ],
                        // set the initial value
                        "pageLength": <?php echo e(config("constants.PAGE_LENGTH_BASIC")); ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/settings/emailTemplate/list.blade.php ENDPATH**/ ?>