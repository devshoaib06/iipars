      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="tabCont">
                    <h1>My Account</h1>
                    <a href="<?php echo e(route('contributor-edit-account',['user_id'=>Hasher::encode($userinfo->id)])); ?>"><input type="button" value="Edit account" style="float: right;" /></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Qualification:</td>
                                        <td><?php echo e($userinfo->qualification); ?></td>
                                    </tr>
                                    <tr>
                                        <td>My Subject:</td>
                                        <td><?php echo e($relatedsubject); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.layout_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/frontend/contributor/myAccount.blade.php ENDPATH**/ ?>