                            ...
                            <table class="table table-bordered" id="order_table">
                                ...
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(\Carbon\Carbon::parse($order->end_date)->format('d/m/Y')); ?></td>
                                        <td><?php echo e($status); ?></td>
                                    <td><a href="#" data-order_id=<?php echo e($order->id); ?> class="btn btn-sm btn-default viewBilling" data-toggle="modal" data-target="#myModal"><i class="fa fa-eye"></i> View </a></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.layout_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/frontend/orders.blade.php ENDPATH**/ ?>