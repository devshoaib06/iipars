                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> CMS <?php /*if(isset($CmsMasters) && !empty($CmsMasters)) echo "(".count($CmsMasters).")"; */?></span>
                                </div>
                                <!--<div class="actions">
                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group">
                                                <a href="<?php echo e(url(config("constants.admin_prefix").'/cms/add')); ?>"><button id="sample_editable_1_new" class="btn sbold green"> Add New
                                    ...
                                    <tbody>
                                        ...
                                        if(!empty($CmsMasters))
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td> <?php echo e(App\library\myFunctions::dateText($v->updated_at,'d_m_y')); ?> </td>
                                                <td>
                                                    <?php if($v->status == '1'): ?>
                                                ...
                                                <td>  
                                                 ...
                                                 <a  href="<?php echo e(url(config("constants.admin_prefix").'/cms/edit')); ?>/<?php echo e(\Hasher::encode($v->cms_id)); ?>" data-toggle="tooltip" class="btn btn-default btn-sm"><i class="fa fa-edit "></i>Edit</a>
    ...
    var table = $('#sample_1');
            ...
            "sortAscending": ": activate to sort column ascending",
                    ...
                    "lengthMenu": [
                            ...
                            [ <?php echo e(config("constants.LENGTH_MENU_BASIC_2")); ?>, "All"]
                    ],
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/settings/cms/list.blade.php ENDPATH**/ ?>