                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-user "></i>
                                    <span class="caption-subject  sbold ">Edit Article - <?php echo e($article_info->name); ?>
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="<?php echo e(route('article-update',['id'=>\Hasher::encode($article_info->id)])); ?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="title" class="form-control"  value="<?php echo e($article_info->title); ?>"/> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea name="description" id="description"  class="form-control" rows="5" cols="7"><?php echo e($article_info->description); ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox-list col-md-6 subject-list">
                                               <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input id="example-inline-checkbox<?php echo e($category->id); ?>" type="checkbox" 
                                                    value="<?php echo e($category->id); ?>" name="category_list[]" 
                                                    <?php echo e(@in_array($category->id,$selected_cat)?'checked':''); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="meta_tags" class="form-control" value="<?php echo e($article_info->meta_tags); ?>" id="meta_tags"/> </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="meta_title" class="form-control" value="<?php echo e($article_info->meta_title); ?>" id="meta_title"/> </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="meta_robots" class="form-control" value="<?php echo e($article_info->meta_robots); ?>" id="meta_robots"/> </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="meta_description" rows="10" class="form-control" id="meta_description"><?php echo e($article_info->meta_description); ?></textarea>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="writer_name" class="form-control" value="<?php echo e($article_info->writer_name); ?>" id="writer_name"/> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="writer_email" class="form-control" value="<?php echo e($article_info->writer_email); ?>" id="writer_email"/> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="writer_phone" class="form-control" value="<?php echo e($article_info->writer_phone); ?>" id="writer_phone"/> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img src="<?php echo e(Storage::disk(config('disk.get_article_image'))->url($article_info->image)); ?>" width="100px" height="100px">
                                                <?php else: ?>
                                                <img src="<?php echo e(Storage::disk(config('disk.get_article_image'))->url('no-image.jpg')); ?>" width="100px" height="100px">
                                                <?php endif; ?>
											</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <a href="<?php echo e(route('downloadArticleFile',['article_id'=>\Hasher::encode($article_info->id)])); ?>">
                                                    <?php echo e($article_info->fileName); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="featured-inline-radio1">
                                                    <input id="featured-inline-radio1" type="radio" value="1" name="is_featured" <?php echo e($article_info->is_featured==1?'checked':''); ?>> Yes</label>
                                                <label class="radio-inline" for="featured-inline-radio2">
                                                    <input id="featured-inline-radio2" type="radio" value="0" name="is_featured" <?php echo e($article_info->is_featured==0?'checked':''); ?>> No</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                        <div class="form-group">
                                            ...
                                            <div class="radio-list col-md-6">
                                                <label class="radio-inline" for="example-inline-radio1">
                                                    <input id="example-inline-radio1" type="radio" value="1" name="status" <?php echo e($article_info->status==1?'checked':''); ?>> Active</label>
                                                <label class="radio-inline" for="example-inline-radio2">
                                                    <input id="example-inline-radio2" type="radio" value="0" name="status" <?php echo e($article_info->status==0?'checked':''); ?>> Inactive</label>
                                            </div>
                                        </div>  <!--Status Value-->
                                    </div>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="<?php echo e(route('article-list')); ?>"><button type="button" class="btn grey-salsa btn-outline">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/articles/edit.blade.php ENDPATH**/ ?>