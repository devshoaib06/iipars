                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
											...
											?> 
                                           <div class="btn-group">
                                                <a href="<?php echo e(route('createMentor')); ?>"><button id="sample_editable_1_new" class="btn sbold green"> Add New
            ...
            var handleHistory = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                        ...
                        "bProcessing": true,
                        "ajax": {                            
                            "url": "<?php echo e(route('ajax-mentor-list')); ?>", // ajax source					
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teachinns/public_html/resources/views/admin/users/mentor/list.blade.php ENDPATH**/ ?>